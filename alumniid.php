            ...
            <div id="heading-breadcrumbs" style="background-color: rgb(200, 211, 230)">
                <div class="container">
                    <div class="row d-flex align-items-center flex-wrap">
                        <div class="col-md-7">
                            <h1  style="font-weight:bold;">ALUMNI ID</h1>
                        </div>
            ...
            <section class="bg-white py-5">
                <div class="container-fluid">
                    ...
                    <div class="row m-5 justify-content-center ">
                        <div class="col-lg-6 d-flex justify-content-md-between">
                          
                            <div class="">
                                <img src="resources/images/onlineservices/tac.png" height="170" class=" mr-5 mb-3 d-block d-sm-block  d-md-none d-lg-non d-xl-none"/>
                                <h2 style="color:#0B2F8F;font-weight: bold; font-size: 2.8rem;">Alumni Card Perks and Privileges</h2>
                                <p ><b>Tuition Fee Discounts:</b> AUUAI ID will entitle alumni to Tuition fee discounts (5% for Children and 3% for siblings of alumni). </p>
                                <p ><b>Access to University Facilities:</b> Alumni IDs can also provide access to university facilities such as libraries. This can be a great perk for those who want to continue using these resources after graduation. </p>
                                <p ><b>Access to Alumni Networks:</b> Adamson University have alumni association or networks, which can offer a range of benefits such as networking opportunites, career advice, and job postings. You can gain access to these networks and benefit from their resources by having an AUAAI ID. </p>
                                <p ><b>Discounts:</b> The University has partnerships with various companies that offer discounts to alumni. Currently, we are working on partnering with different merchants and establishments for additional perks and discounts.</p>
                                <p ><b>Career Services:</b> Adamson University offer career services to alumni, including resume building, job search assistance, and career counseling. By having an alumni ID you can continue to access these services and get help advancing your career.</p>
                                <p ><b>Continued Learning:</b> Adamson University offer alumni the opportunity to get discounts to take classes or participate in continuing education programs. Having an alumni ID can givve you access to these programs and allow you to continue learning and growing in your field.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-between">
                            <img src="resources/images/alumnicard.png" height="700px" class=" mr-5 mb-3 d-none d-md-block"/>
                            
                        </div>
  
                    <div class="text-center mx-5">
                        <hr/>
                        <p style="font-weight: bold; font-size: 2.5rem; color:#0B2F8F ">Get Yours Now!</p><br>
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#yearModal">APPLY HERE</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="yearModalLabel">Reminder Message</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            Please be aware that all the information you enter on this form will directly appear on your ID. Make sure all details are accurate, as you will not be able to edit them once submitted. Exercise caution and double-check your spelling and all provided information. Your attention to detail is greatly appreciated.
             
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
             
                <a href="idregister.php" class="btn btn-primary rectangular-button" style="color: white" role="button">I understand</a>
            </div>
        </div>
    </div>
</div>                 
