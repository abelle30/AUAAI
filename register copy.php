...
return true;
        ...
        <title>AUAAI-login/register</title>
                ...
                <div class="row">
                    <div class="col-md-3 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                            ...
                            <span class="font-weight-bold">John Wick</span>
                            <span class="text-black-50">john.wick@example.com</span>
                            <span> </span>
                        </div>
                    </div>
                        ...
                        <div class="card-body bg-white">
                            ...
                            <h4 class="text-info">User Credentials</h4>
                              ...
                              <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                  <input type="password" class="form-control"  placeholder="Re-Type Password" name="retypepassword_confirmation" id="password_confirmation">
                            ...
                            <div class="mt-5 text-center">
                                <button class="btn btn-primary profile-button" type="submit" value="register" name="register">Submit Registration</button>
...
{  
    $course=$_POST['course'];//here getting result from the post array after submitting the form.  
    $fname=$_POST['fname'];//same  
    $lname=$_POST['lname'];
    $age=$_POST['age'];//same  
    $suffix=$_POST['suffix'];//same  
    $gender=$_POST['gender'];//same  
    $Nationality=$_POST['Nationality'];
    $civilstatus=$_POST['civilstatus'];//same  
    $lot=$_POST['lot'];
    $street=$_POST['street'];//same  
    $city=$_POST['city'];
    ...
    {  
        ...
        echo"<script>alert('Please enter the course)</script>";  
...
//insert the user into the database.  
    $insert_user="insert into users (username,password,email,usertype) VALUE ('$username','$password','$email','$usertype')";  
