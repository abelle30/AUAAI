...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    // Hash the password for comparison (assuming you're storing hashed passwords in the database)
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $_SESSION["usertype"] = $resultSet["usertype"];
        $_SESSION['fname']=$resultSet['fname'];
        $_SESSION['id']=$resultSet['id'];
        $_SESSION['mname']=$resultSet['mname'];
        $_SESSION['suffix']=$resultSet['suffix'];
        $_SESSION['age']=$resultSet['age'];
        $_SESSION['lname']=$resultSet['lname'];
        $_SESSION['year']=$resultSet['year'];
        $_SESSION['course']=$resultSet['course'];
        $_SESSION['lot']=$resultSet['lot'];
        $_SESSION['street']=$resultSet['street'];
        $_SESSION['nationality']=$resultSet['nationality'];
        $_SESSION['city']=$resultSet['city'];
        $_SESSION['state']=$resultSet['state'];
        $_SESSION['mobileno']=$resultSet['mobileno'];
        ...
        if ($_SESSION['usertype'] == 'admin') {
            ...
            if ($_SESSION['status'] == 'unverified') {
                mysqli_close($conn);
                $_SESSION['error'] = "Your account is unverified. Please verify your email.";
            ...
            if ($_SESSION['usertype'] == 'alumni') {
              ...
              // Insert the email into the userlog table
              $log = mysqli_query($conn, "INSERT INTO userlog (email) VALUES ('$email')");
      
              mysqli_close($conn);
              header("Location: user/userloggedIN.php");
              exit();
            }
            ...
            <div class="bg-image"  style="background-image: (resources/images/ADAMSON-1.jpg); height: 100vh;">   
                ...
                <br>
                    ...
                    <div class="container justify-content-center">
                        ...
                        <p class="pmessage">In order to stay in touch with us, kindly sign in 
...
<?php } ?>
                                ...
                                <div class="card-footer">
                                    <div class="d-flex justify-content-center links">
                                        <p class="text-right"><a href="forgotpassworduser.php" class="btn px-0 text-midblue">Forgot Password</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-9 col-md-10 col-lg-5 mx-auto">
                        <div class="cardlogin text-center mb-5" style="width: 27rem;">
                            <div class="card-body2">
                            <h5 class="card-title">Not registered yet?</h5>
                            <p class="card-text">Hello, Adamsonian Alumni! Provide your personal information to begin 
