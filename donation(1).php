...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO donations (fname, lname, donationtype, Donation_Type_Details, usertype) VALUES (?, ?, ?, ?, ?)";
    
    // Prepare the statement
    $stmt = $conn->prepare($query);

    // Bind parameters
    $stmt->bind_param("sssss", $fname, $lname, $donationtype, $Donation_Type_Details, $usertype);
                    ...
                    <div class="if1 heading mt-5 row justify-content-between">
                        ...
                        <div class="how col-6">
                            <div class="container mt-2">
                                <form action="donation(1).php" method="post" action="submit">
