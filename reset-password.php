...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    // Check if the email and token combination exists in the reset_tokens table
    $db_host = '';
    ...
    try {
        ...
        $stmt = $pdo->prepare("SELECT * FROM reset_tokens WHERE user_email = :user_email AND reset_token = :reset_token AND expiration_timestamp > NOW()");
        ...
        // Include HTML and form for resetting the password
        ?>
...
?>
            ...
            <div class="bg-image"  style="background-image: (resources/images/ADAMSON-1.jpg); height: 100vh;">   
                ...
                <br>
                    ...
                    <div class="container justify-content-center">
                        ...
                        <p class="pmessage">Strong password required. Enter 8-256 characters. Do not include common words or name. Combine uppercase letters, lowercase letters, numbers, and symbols.</p>
                    </div>
                <br>  
                <br>
                </div>
 ...
 <input type="hidden" name="email" value="<?php echo htmlspecialchars($email); ?>">
                       <input type="hidden" name="token" value="<?php echo htmlspecialchars($token); ?>">
                            ...
                            <div class="card-body">
                                    <p class="pmessage" style="color: white;">New Password</p>
                                <div class="input-group form-group">
                                    ...
                                    <input name="new_password" type="password" id="new_password" name="new_password" class="form-control"  placeholder="">    
                                 
                                </div>
                              
      <p class="pmessage" style="color: white;">Confirm password</p>
                                <div class="input-group form-group">
                                    ...
                                    <input name="confirm_password" type="password"  id="confirm_password" name="confirm_password" class="form-control" placeholder="">
 ...
 <?php if (isset($_SESSION['success'])) { ?>
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-primary profile-button" type="submit">Reset Password</button>
                                    </div>
                                </div>
                                </form>
