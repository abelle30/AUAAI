        ...
        <br>
         <div id="heading-breadcrumbs" style="background-color: rgb(200, 211, 230)">
            <div class="container text-center">
                <i><p class="text-black" style="font-size: 15px; color: #000; font-weight: bold; line-height: 1.5;text-align: justify"> Dear Adamson Alumni, <br><br>
    ...
    <div class="card" style="width: 70rem;">
        <div class="card-header h4" style="background-color: #5b9aff; text-align:left">Fill Alumni Information</div>
            <div class="card-body bg-white">
               ...
               <!-- Textbox with Modal Trigger -->
                <div class="form-group row">
                    <label class="col-form-label col-md-3">Year Graduated</label>
                    <div class="col-md-5">
                        <button type id="year" name="year" class="form-control form-control-sm mb-4" data-bs-toggle="modal" data-bs-target="#yearModal"></select>
                        </button>
                    </div>
                </div>
                ...
                <div class="modal fade" id="yearModal" tabindex="-1" aria-labelledby="yearModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            You are not registered yet. Register to access alumni tracer form
                ...
                <div class="form-group row border-bottom">
                    <label class="col-form-label col-md-3">Course/Program</label><br>
                        <div class="col-md-5">
                          <button onchange="course()" id="course" name="course" data-bs-toggle="modal" data-bs-target="#yearModal" class="form-control form-control-sm mb-3">
                        </div>                    
                </div>
                ...
                <h4 class="text-info" style="text-align: left;">Personal Information</h4>
                    <div class="personal">
                                    <div class="row mb-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name" name="name" id="name" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 500px">
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-form-label" style="text-align: left;">Age</label>
                                        <input type="text" class="form-control" placeholder="Age" name="age" id="age" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 500px">
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-form-label" style="text-align: left;">Gender</label>
                                        <select onchange="gender()" class="form-control form-control-sm mb-3" name="gender" id="gender" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 500px">
                                        </select>
                                    </div>
                                     <div class="row mb-2">
                                        <label class="col-sm-2 col-form-label" style="text-align: left;">Nationality</label>
                                        <input type="text" class="form-control" placeholder="Nationality" data-bs-toggle="modal" data-bs-target="#yearModal" name="name" id="name" value="" style="border-radius: 20px; width: 200px">
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-sm-2 col-form-label" style="text-align: left;">Civil Status</label>
                                         <select onchange="civilstatus()" class="form-control form-control-sm mb-3" name="civilstatus" id="civilstatus" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 200px">
                                                </select>
                                    </div>
                ...
                <h4 class="text-info" style="text-align: left;">Contact Information</h4>
                    <div class="personal">
                            ...
                            <div class="row mb-2">
                                ...
                                <input type="text" class="form-control" placeholder="Lot/Blds/Subd/Unit/Floor No." name ="lot" id ="lot" value=""  data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            
                                <label class="col-sm-1 col-form-label" style="text-align: left;">Street</label>
                                <input type="text" class="form-control" placeholder="Street" name ="street" id ="street" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-1 col-form-label" style="text-align: left;">City</label>
                                <input type="text" class="form-control" placeholder="City" name ="city" id ="city" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                           
                                <label class="col-sm-2 col-form-label" style="text-align: left;">State/Province</label>
                                <input type="text" class="form-control" placeholder="State/Province" name ="state" id ="state" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Mobile Number</label>
                                 <input type="text" class="form-control" placeholder="Mobile Number" name ="mobileno" id ="mobileno" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            </div>
                    </div>
                ...
                <h4 class="text-info" style="text-align: left;">Employment Information</h4>
                   <div class="">
                            <div class="row mb-2">
                                ...
                                <select onchange="emp_status()" class="form-control form-control-sm mb-3" name="emp_status" id="emp_status" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                                    
                                </select>
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Name of the Company</label>
                                <input type="text" class="form-control" placeholder="" name="e_name_of_business" id="e_name_of_business" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                                
                            </div>

                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Current Job Position</label>
                                <input type="text" class="form-control" placeholder="" name="current_job_position" id="current_job_position" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Company Affiliation</label>
                                <input type="text" class="form-control" placeholder="" name="company_affiliation" id="company_affiliation" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width:300px">
                           </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Company Address</label>
                                <input type="text" class="form-control" placeholder="" name="company_address" id="company_address" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Current Job Industry Type</label>
                                 <input type="text" class="form-control" placeholder="" name="job_industry_type" id="job_industry_type" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Approximate Monthly Salary</label>
                                 <input type="text" class="form-control" placeholder="" name="monthly_salary" id="monthly_salary" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Date Employed</label>
                                <input type="date" class="form-control" placeholder="" name="e_date_employed" id="e_date_employed" value="" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                               
                            </div>
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Employment Status</label>
                                <select class="form-control" name="e_emp_status" id="e_emp_status" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 300px">
                    ...
                    <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                        <td for="source">In your first employment, which of the following has been your source?</td>
                        <div class="employquestion">
                                   <div class="col-md-10" style="text-align: left">
                                        <td>
                                        <select onchange="emp_source()" class="form-control form-control-sm mb-3" name="emp_source" id="emp_source" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 400px">
                    ...
                    <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                        <td for="emp_immediate">Have you been employed immediately 6 months or less after graduation?</td>
                            <div class="employquestion">
                                       <div class="col-md-10" style="text-align: left">
                                            <td>
                                            <select onchange="emp_immediate()" data-bs-toggle="modal" data-bs-target="#yearModal" class="form-control form-control-sm mb-3" name="emp_immediate" id="emp_immediate" style="border-radius: 20px; width: 200px">
                                                <option disabled selected>--- Select ---</option>
                                            </select>
                                            </td>   
                                        </div>
                    ...
                    <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                        <td for="job_relate">Is your job related to your course?</td>
                            <div class="employquestion">
                                       <div class="col-md-10" style="text-align: left">
                                            <td>
                                            <select onchange="job_relate()" class="form-control form-control-sm mb-3" name="job_relate" id="job_relate" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 200px">
                                                <option disabled selected>--- Select ---</option>
                                            </select>
                                            </td>   
                                        </div>
                    ...
                    <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                        <td>How satisfied are you with your current job?</td>
                            <div class="employquestion">
                                        <div class="col-md-10" style="text-align: left">
                                            <td>
                                            <select onchange="job_satisfaction()" class="form-control form-control-sm mb-3" name="job_satisfaction" id="job_satisfaction" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 200px">
                                                <option disabled selected>--- Select ---</option>
                                            </select>
                                            </td>      
                                        </div>
                    ...
                    <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                        <td for="intend_to_stay">Do you intend to stay in the same job/profession?</td>
                            <div class="employquestion">
                                        <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                                           <div class="col-md-10" style="text-align: left">
                                                <td>
                                                <select onchange="intend_to_stay()" class="form-control form-control-sm mb-3" name="intend_to_stay" id="intend_to_stay" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 20px; width: 200px">
                                                    <option disabled selected>--- Select ---</option>
                                                </select>
                                                </td>   
                                            </div>
                        ...
                        <input type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 10px;width: 150px; height: 40px; font-size: 16px;" name="submit" value="Submit"> 
...
<b>**Note: This section will allow you to add and save multiple records.</b>
                        ...
                        <table id="degree_record1" style="margin-left: 85px !important;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><input type="text" name="course1[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 300px; height: 40px;"></td>
                                                            <td><input type="text" name="school1[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 300px; height: 40px;"></td>
                                                            <td><input type="date" name="date1[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 200px; height: 40px;" readonly></td>
                                                            <td><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#yearModal" data-bs-toggle="button" style="border-radius: 10px;">Delete</button></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <hr>
                                               
                                                <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 10px;">Add Masters Degree Record</button>
                                                <br>
                                                ...
                                                <script>
                                                    function addRow1() {
                                                        ...
                                                        cell4.innerHTML = '<button type="button" data-bs-toggle="button" class="btn btn-danger" onclick="deleteRow1(this)" style="border-radius: 10px;">Delete</button>';
                                                    }
                        ...
                        <form method="POST" id="degree_recs2">
                        <table id="degree_record2" style="margin-left: 85px !important;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><input type="text" name="course2[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 300px; height: 40px;"></td>
                                                            <td><input type="text" name="school2[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 300px; height: 40px;"></td>
                                                            <td><input type="date" name="date2[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 200px; height: 40px;" readonly></td>
                                                            <td><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#yearModal" data-bs-toggle="button" style="border-radius: 10px;">Delete</button></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 10px;">Add Doctorate Degree Record</button>
                                                <br>
                                                ...
                                                <script>
                                                    function addRow2() {
                                                        ...
                                                        cell4.innerHTML = '<button type="button" class="btn btn-danger" data-bs-toggle="button" onclick="deleteRow2(this)" style="border-radius: 10px;">Delete</button>';
                                                    }
                        ...
                        <form method="POST" id="degree_recs3">
                        ...
                        <table id="licensure_records" style="margin-left: 250px !important;">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><input type="text" name="course3[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 300px; height: 40px;"></td>
                                                            <td><input type="date" name="school3[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 200px; height: 40px;" readonly></td>
                                                            <td><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#yearModal"  style="border-radius: 10px;">Delete</button></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <hr>
                                               
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 10px;">Add Licensure Exam Record</button>
                                                <br>
                                                ...
                                                <script>
                                                    function addRow3() {
                                                        ...
                                                        cell2.innerHTML = '<input type="date" name="school3[]" style="width: 200px; height: 40px;">';
                                                        cell3.innerHTML = '<button type="button" class="btn btn-danger" data-bs-toggle="button" onclick="deleteRow3(this)" style="border-radius: 10px;">Delete</button>';
                                                    }
                        ...
                        <form method="POST" id="emp_recs">
                            <table id="employment_records">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="text" name="name_company[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 250px; height: 40px;"></td>
                                            <td><input type="date" name="date_employed[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 150px; height: 40px;" readonly></td>
                                            <td><input type="text" name="emp_position[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 220px; height: 40px;"></td>
                                            <td><input type="text" name="employment_status[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 220px; height: 40px;"></td>
                                            
                                            <td>
                                                <select name="approx_monthly_salary[]" data-bs-toggle="modal" data-bs-target="#yearModal" style="width: 150px; height: 40px;">
                                                    <option value="0">- Select -</option>
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 10px;">Add Employment Record</button>
                                <br>
                                ...
                                <script>
                                    function addRow() {
                                        ...
                                        cell4.innerHTML = '<input type="text" name="employment_status[]" style="width: 220px; height: 40px;">';
                                        cell5.innerHTML = '<select name="approx_monthly_salary[]" style="width: 150px; height: 40px;">' +
                                                        ...
                                                        '<option value="25,001 Above">25,001 Above</option>' +
                                                        '</select>';
                                        cell6.innerHTML = '<button type="button" data-bs-toggle="button" class="btn btn-danger" onclick="deleteRow(this)" style="border-radius: 10px;">Delete</button>';
                                    }
...
<br><br>
                        <button type="button" class="btn btn-success" name="addemprecord" data-bs-toggle="modal" data-bs-target="#yearModal" style="border-radius: 10px;">Update Career Insights</button>
                        </form>
