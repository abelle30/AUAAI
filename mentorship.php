...
<?php 
     if (isset($_GET['pageno'])) {
        ...
        $query = mysqli_query($conn, "SELECT mentorship.id as id, mentorship.PostTitle as PostTitle, mentorship.PostImage, mentorship.CategoryName as CategoryName, mentorship.description as description, mentorship.date as date FROM mentorship ORDER BY mentorship.id DESC LIMIT $offset, $no_of_records_per_page");
