...
<a href="admindashboard.php" class="navlogo-item "><center> <img src="resources/images/adulogoadmin.png" class="nav-avatar" /></i></span> Dashboard</a></center> 
    ...
    <ul>
        ...
        <li>
            <a href="userloginlog.php">Manage Footer</a>
            <ul>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Footer</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Footer Information </h2>
					</div>
...
<td>
<a tittle="Edit Details" href="edit-footer.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
<a tittle="Remove Products" href="manage-footer.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
