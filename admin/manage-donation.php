...
if(isset($_GET['del']))
		  {
		          mysqli_query($conn,"delete from donations where id = '".$_GET['id']."'");
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Donations</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Donations List </h2>
					</div>
...
$query = mysqli_query($conn, "SELECT donations.id AS id, donations.fname,
                              donations.lname, donations.donationtype, donations.usertype, donations.Donation_Type_Details
...
<td><?php echo $row['Donation_Type_Details']; ?> </td>  
<td><?php echo $row['usertype']; ?></td>  

<!--<td>-->
<!--<a tittle="Edit Details" href="edit-donation.php?id= "><i class="icon-edit">Edit</i></a>-->
<!--</td>-->
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
