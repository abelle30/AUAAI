...
<form class="form-horizontal row-fluid" name="edituser" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    ...
                    <input type="fname" class="form-control2" id="fname" name="fname"  value="" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Middle name</b></label>
                    <input type="mname" class="form-control2" id="mname" name="mname" value="" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Last name</b></label>
                    <input type="lname" class="form-control2" id="lname" name="lname" value=""  required>
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Suffix</b></label>
                    <input type="suffix" class="form-control2" id="suffix" name="suffix" value=""  required>
                </div>
    ...
    <div class="form-group row">
        <div class="col-md-2"> <!-- Adjust col-md-2 to your desired width class -->
            <select id="year" name="year" class="form-control form-control-sm mb-9"></select>
        </div>
    </div>
</div>
...
<div class="col-md-5">
                                  ...
                                  <select onchange="course()" id="course" name="course"  value="course" class="form-control form-control-sm mb-3
                                  ">
                                      <option> </option>
...
<div class="form-group col-md-3">
				<label for="mobileno"><b>Gender</b></label>
                                  ...
                                  <select onchange="gender()" id="gender" name="gender" class="form-control form-control-sm mb-3
                                  ">
                                      <option></option>
				...
				<div class="form-group col-md-3">
                    ...
                    <input type="email" class="form-control2" id="email" name="email" value=""  required>
                </div>

				<div class="form-group col-md-3">
                    <label for="email"><b>Password</b></label>
                    <input type="password" class="form-control2" id="password" name="password"  value="" required>
                </div>
				...
				<div class="form-group col-md-3">
				<label for="mobileno"><b>Usertype</b></label>

                              
                                  <select onchange="usertype()" id="usertype" name="usertype" class="form-control form-control-sm mb-3
                                  ">
                                      <option></option>
            ...
            <div class="div">
                ...
                <div class="form-group col-md-3">
                   ...
                   <label2>"""""""""</label2>
					...
					<button class="btn btn-danger" onclick="window.location.href = '/admin/alumnicolleges.php';">Cancel</button>
