...
<form method="get" action="">
    ...
    <select name="courseFilter" id="courseFilter">
       ...
       <option value="Bachelor of Science in Architecture">Bachelor of Science in Architecture</option>
        ...
        <!-- Add more options for each course you have -->
    </select>
    <button  class="btn btn-primary" type="submit">Apply</button>
         ...
         <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm');"><i class="plus"></i> Import a CSV file</a>
            ...
            <a href="exportcsvfile-alumniid.php" class="btn btn-primary"><i class="exp"></i> Export CSV file</a>
       
    <!-- CSV file upload form -->
    <div class="col-md-12" id="importFrm" style="display: none;">
        <form action="importcsvfile-alumniid.php" method="post" enctype="multipart/form-data">
    ...
    <div class="card-header">
        <h2 class="alumniList">Alumni ID Application List</h2>
    </div>
    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped display" width="100%">
        ...
        <tbody>
            <?php
            // Check if the form is submitted and filter by course
            $courseFilter = isset($_GET['courseFilter']) ? $_GET['courseFilter'] : '';

            $filterCondition = "";
            if (!empty($courseFilter)) {
                $filterCondition = " AND alumniid.Course = '$courseFilter'";
            }

            $query = mysqli_query($conn, "SELECT alumniid.id AS id, alumniid.idpic, alumniid.alumniname AS alumniname, alumniid.YearGraduated AS YearGraduated, alumniid.StudentNumber AS StudentNumber, alumniid.Course AS Course, alumniid.PersonalEmailAddress AS PersonalEmailAddress, alumniid.CompanyName AS companyname, alumniid.CompanyAddress AS CompanyAddress, alumniid.Position AS Position, alumniid.Birthday AS Birthday, alumniid.typeofcard AS typeofcard, alumniid.proofofpayment, alumniid.esignature FROM alumniid WHERE alumniid.status=1" . $filterCondition);
            ...
            while ($row = mysqli_fetch_array($query)) {
                echo "<tr>";
                echo "<td>{$cnt}</td>";
                echo "<td><img src='resources/images/{$row['idpic']}' class='img-fluid rounded-start'></td>";
                echo "<td>{$row['alumniname']}</td>";
                echo "<td>{$row['StudentNumber']}</td>";
                echo "<td>{$row['Course']}</td>";
                echo "<td>{$row['YearGraduated']}</td>";
                echo "<td>{$row['Position']}</td>";
                echo "<td>{$row['typeofcard']}</td>";
                echo "<td><img src='resources/images/{$row['proofofpayment']}' class='img-fluid rounded-start'></td>";
                echo "<td><img src='resources/images/{$row['esignature']}' class='img-fluid rounded-start'></td>";
                echo "<td><a title='Complete' href='complete-alumniid.php?id={$row['id']}&PersonalEmailAddress={$row['PersonalEmailAddress']}'><i class='icon-edit'>Complete</i></a></td>";
                echo "</tr>";
                $cnt++;
            }
            ?>
