		...
		if(isset($_POST['submit']))
{
    ...
    $query=mysqli_query($conn,"select * from announcements where id='$pid'");
	$result=mysqli_fetch_row($query);
	

	$Msg = 'Announcement Added!';
	
$sql=mysqli_query($conn,"UPDATE  announcements SET 
title='$title', postdate='$postdate', content='$content'
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Edit Announcement</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="edituser" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    ...
                    <input type="title" class="form-control2" id="title" name="title"  value="<?php echo htmlentities($row['title']);?>" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Date</b></label>
                    <input type="postdate" class="form-control" placeholder="" value="<?php echo htmlentities($row['postdate']);?>"  id="postdate" name="postdate"  style="border-radius: 20px; width: 170px">
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Content</b></label>
                    <textarea class="summernote" id="content" name="content" value="" required><?php echo htmlentities($row['content']);?></textarea>
                </div>
...
<script>
    function cancelForm() {
        window.location.href = 'https://auaaiconnect.online/admin/manageannouncements.php';
    }
