    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Announcements</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Announcements List </h2>
					</div>
...
$query = mysqli_query($conn, "SELECT announcements.id AS id, announcements.title AS title,
                              announcements.postdate AS postdate, announcements.content AS content 
...
<td>
<a tittle="Edit Details" href="edit-announcements.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
<a tittle="Remove Products" href="manageannouncements.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
