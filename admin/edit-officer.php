...
exit();
  ...
  $pid = intval($_GET['officerID']);
    ...
    $query = mysqli_query($conn, "select * from officers where officerID='$pid'");
    $result = mysqli_fetch_row($query);


        
        
        $sql = mysqli_query($conn, "UPDATE officers SET 
    Name = '$Name',
    Position = '$Position',
    image = '$new_img_name',
      year = '$year',
    ...
    if ($sql) {
        $_SESSION['msg'] = "Officer Updated!";
    } else {
        $_SESSION['msg'] = "Officer update failed!";
    }
}
?>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Edit Officer</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="editofficer" method="post" enctype="multipart/form-data">

									
			<div class="form-group col-md-3">
                    <label for="firstname"><b>Name</b></label>
                    <input type="upcomingevent" class="form-control2" id="Name" name="Name"  value="<?php echo htmlentities($row['Name']);?>" required>
                </div>
                
                							
			<div class="form-group col-md-3">
                    <label for="firstname"><b>Position</b></label>
                    <input type="upcomingevent" class="form-control2" id="Position" name="Position"  value="<?php echo htmlentities($row['Position']);?>" required>
                </div>
                
                
               	<div class="form-group col-md-3">
                    <label for="firstname"><b>Year</b></label>
                     <input type="text" class="form-control2" id="year" name="year" value="<?php echo htmlentities($row['year']);?>" required>
                </div>
...
<script>
    function cancelForm() {
        window.location.href = 'https://auaaiconnect.online/admin/manage-officer.php';
    }
