    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Accounts List </h2>
					</div>
...
$query = mysqli_query($conn, "SELECT DISTINCT email, id, logintime, logout FROM userlog GROUP BY email");
...
<td>
                <a title="View Details" href="view-userloginlog.php?id=<?php echo $row['id']; ?>">View</a>
            </td>
