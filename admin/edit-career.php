		...
		if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($conn,"select companyname from careers where careers.id='$pid'");
	$result=mysqli_fetch_row($query);
	
	
$sql=mysqli_query($conn,"UPDATE careers SET 
companyname='$companyname', companyemailaddress='$companyemailaddress', companyaddress='$companyaddress', 
contactperson='$contactperson', opportunitytype='$opportunitytype', contactno='$contactno',
message='$message'
WHERE id='$pid'");


}
 $_SESSION['msg'] = "Career updated!";
?>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Edit Career</b></h1>
            </div>
...
<?php } ?>
                                    ...
                                    <?php
                                    $query = mysqli_query($conn, "SELECT * from careers
                             WHERE careers.id = '$pid'");
...
?>
<form class="form-horizontal row-fluid" name="editcareer" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    <label for="companyemailaddress"><b>Company email address</b></label>
                    <input type="companyemailaddress" class="form-control2" id="companyemailaddress" name="companyemailaddress" value="<?php echo htmlentities($row['companyemailaddress']);?>" required>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="contactno" class="form-control2" id="contactno" name="contactno" value="<?php echo htmlentities($row['contactno']);?>"  required>
                </div>

				<div class="form-group col-md-3">
                    <label for="email"><b>Contact person</b></label>
                    <input type="contactperson" class="form-control2" id="contactperson" name="contactperson" value="<?php echo htmlentities($row['contactperson']);?>"  required>
                </div>



<label for="mobileno"><b>Opportunity type</b></label>
<div class="col-md-5">
<select id="opportunitytype" name="opportunitytype">
<option value="<?php echo htmlentities($row['opportunitytype']);?>"><?php echo htmlentities($row['opportunitytype']);?></option>
				...
				<div class="form-group col-md-3">
                    ...
                    <textarea class="summernote" id="message" name="message" value="<?php echo htmlentities($row['message']);?>" required></textarea>
                </div>
...
<script>
    function cancelForm() {
        window.location.href = 'https://auaaiconnect.online/admin/manage-careers.php';
    }
