...
$filename = "Engineering_alumni_" . date('Y-m-d') . ".csv"; // Change the filename as per your preference
$delimiter = ",";
...
$result = mysqli_query($conn, "SELECT * FROM users WHERE course IN ( 'Bachelor of Science in Chemical Engineering',
    ...
    'Bachelor of Science in Petroleum Engineering') ORDER BY id DESC");
