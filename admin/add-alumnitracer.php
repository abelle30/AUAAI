...
$sql=mysqli_query($conn,"insert users SET 
fname='$fname', mname='$mname', lname='$lname', suffix='$suffix',
gender='$gender', email='$email', mobileno='$mobileno', password='$password',
year='$year', course='$course', nationality='$nationality', civilstatus='$civilstatus',
state='$state', city='$city', street='$street', usertype='$usertype'
");


}
   $_SESSION['msg'] = "Alumni tracer data added!";
?>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add Alumni Tracer</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="edituser" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="Age" class="form-control2" id="Age" name="Age" value="" required>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="Nationality" class="form-control2" id="Nationality" name="Nationality" value="" required>
                </div>

                <div class="form-group col-md-3">
				<label for="mobileno"><b>Civil status</b></label>

                              
                                  <select onchange="usertype()" id="civilstatus" name="civilstatus" class="form-control form-control-sm mb-3
                                  ">
                                      <option></option>
                ...
                <div class="form-group col-md-3">
                    <label for="email"><b>Lot</b></label>
                    <input type="Lot" class="form-control2" id="Lot" name="Lot" value=""  required>
                </div>

				<div class="form-group col-md-3">
                    <label for="email"><b>Street</b></label>
                    <input type="Street" class="form-control2" id="Street" name="Street" value=""  required>
                </div>

                
				<div class="form-group col-md-3">
                    <label for="email"><b>City</b></label>
                    <input type="City" class="form-control2" id="City" name="City" value=""  required>
                </div>

                <div class="form-group col-md-3">
                    <label for="email"><b>State</b></label>
                    <input type="State" class="form-control2" id="State" name="State" value=""  required>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="MobileNo" class="form-control2" id="Mobileno" name="Mobileno" value=""  required>
                </div>




                <div class="form-group col-md-3"> <!-- Adjust col-md-4 to your desired width class -->
    <label for="mobileno"><b>Employment Status</b></label>
    <select onchange="EmploymentStatus()" id="EmploymentStatus" name="EmploymentStatus" class="form-control form-control-sm mb-3
                                  ">
...
<div class="form-group col-md-3">
                    <label for="email"><b>Current Job Position</b></label>
                    <input type="CurrentJobPosition" class="form-control2" id="CurrentJobPosition" name="CurrentJobPosition" value=""  required>
                </div>

                
<div class="form-group col-md-3">
                    <label for="email"><b>Company Affiliation</b></label>
                    <input type="CompanyAffiliation" class="form-control2" id="CompanyAffiliation" name="CompanyAffiliation" value=""  required>
                </div>
                ...
                <div class="form-group col-md-3">
                    <label for="CompanyAddress"><b>Approximate Monthly Salary</b></label>
                    <input type="ApproximateMonthlySalary" class="form-control2" id="ApproximateMonthlySalary" name="ApproximateMonthlySalary" value=""  required>
                </div> 

                <div class="form-group col-md-3">
                    <label for="CompanyAddress"><b>Current Job Industry Type</b></label>
                    <input type="CurrentJobIndustryType" class="form-control2" id="CurrentJobIndustryType" name="CurrentJobIndustryType" value=""  required>
                </div> 

                <div class="form-group col-md-3">
                    <label for="Firstemployment"><b>First employment</b></label>
                    <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                         ...
                         <div class="col-md-10" style="text-align: left">
                          ...
                          <input class="form-check-input" type="radio" name="source" id="Single"
                              value="option1" />
                          <label class="form-check-label" for="femaleGender">Adamson Job Fair</label>
                          </div>
      
                        
      
                          <div class="form-check form-check-inline mb-0">
                          <input class="form-check-input" type="radio" name="source" id="Widowed"
                              value="option3" />
                          <label class="form-check-label" for="otherGender">Academic Department/Faculty Referral</label>
                          </div>
                          <br>
                          <div class="form-check form-check-inline mb-0">
                              <input class="form-check-input" type="radio" name="source" id="Married"
                                  value="option3" />
                              <label class="form-check-label" for="otherGender">Classified Ads (Printed/Electronic)</label>
                          </div>
                          <br>
                          <div class="form-check form-check-inline mb-0">
                              <input class="form-check-input" type="radio" name="source" id="Seperated"
                                  value="option3" />
                              <label class="form-check-label" for="otherGender">Family and Friends Referral</label>
                          </div>
                          <br>
                          <div class="form-check form-check-inline mb-0">
                              <input class="form-check-input" type="radio" name="source" id="Seperated"
                                  value="option3" />
                              <label class="form-check-label" for="otherGender">Guidance Placement Referral</label>
                          </div>
                          <br>
                          <div class="form-check form-check-inline mb-0">
                              <input class="form-check-input" type="radio" name="source" id="Seperated"
                                  value="option3" />
                              <label class="form-check-label" for="otherGender">OJT Site</label>
                          </div>
                          <br>
                          <div class="form-check form-check-inline mb-0">
                              <input class="form-check-input" type="radio" name="source" id="Seperated"
                                  value="option3" />
                              <label class="form-check-label" for="otherGender">Walk-in Application</label>
                          </div>
                          <br>
                          <div class="form-check form-check-inline mb-0">
                              <input class="form-check-input" type="radio" name="source" id="Seperated"
                              ...
                              <td><input type="textarea" class="form-control" placeholder="Please specify" value="" style="border-radius: 20px; width:250px;">
                              </td>
                          </div>
                ...
                <div class="form-group col-md-3">
                    <label for="email"><b>Current Job Industry Type</b></label>
                    <div class="form-check">
                                        <input type="radio"  name="CurrentJobIndustryType" id="CurrentJobIndustryType" value="Private">
                                        <label name="CurrentJobIndustryType">
                                          Private
                                        </label>
                                        
                                      </div>
                                      <div class="form-check">
                                        <input type="radio" name="CurrentJobIndustryType" id="CurrentJobIndustryType" value="Goverment">
                                        <label  name="CurrentJobIndustryType">
                                          Goverment
                                        </label>
                                      </div>
                                      ...
                                      <div class="form-check">
                                        <input type="radio" name="CurrentJobIndustryType" id="CurrentJobIndustryType" value="NGO">
                                        <label  name="CurrentJobIndustryType">
                                          NGO
                                        </label>
                                      </div>
                ...
                <div class="form-group col-md-3">
                    <label for="email"><b>Have you been employed immediately 6 months or less after graduation?</b></label>
                    <div class="form-check">
                                        <input type="radio"  name="empimp" id="empimp" value="Yes">
                                        <label name="CurrentJobIndustryType">
                                       Yes
                                        </label>
                                      ...
                                      <div class="form-check">
                                        <input type="radio" name="empimp" id="empimp" value="No">
                                        <label  name="CurrentJobIndustryType">
                                      No
                                        </label>
                                      </div>
                ...
                <div class="form-group col-md-3">
                    <label for="email"><b>How satisfied are you with your current job?</b></label>
                    <div class="form-check">
                                        <input type="radio"  name="satisfaction" id="satisfaction" value="Yes">
                                      ...
                                      <div class="form-check">
                                        <input type="radio" name="satisfaction" id="satisfaction" value="No">
                                        <label  name="satisfaction">
                                      No
                                        </label>
                                      </div>
                ...
                <div class="form-group col-md-3">
                        <label for="intend"><b>Is your job related to your course?</b></label>
                    </div>
                        ...
                        <div class="employquestion">
                            <div class="row mt-3" style="margin-left: 4%" >
                                <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                                   ...
                                   <div class="col-md-10" style="text-align: left">
                                    <div class="form-check form-check-inline mb-0 me-5" style="align-content:center">
                                    <input class="form-check-input" type="radio" name="intend" id="Single"
                                        value="option1" />
                                    <label class="form-check-label" for="femaleGender">Yes</label>
                                    </div>

                                    <div class="form-check form-check-inline mb-0">
                                    <input class="form-check-input" type="radio" name="intend" id="Widowed"
                                        value="option3" />
                                    <label class="form-check-label" for="otherGender">No</label>
                                    </div>
                ...
                <div class="form-group col-md-3">
                    <label for="email"><b>Do you intend to stay in the same job/profession?</b></label>
                    <div class="form-check">
                                        <input type="radio"  name="satisfaction" id="satisfaction" value="Yes">
                                        <label name="satisfaction">
                                       Yes
                                      ...
                                      <div class="form-check">
                                        <input type="radio" name="sameprofession" id="sameprofession" value="No">
                                        <label  name="sameprofession">
                                      No
                                        </label>
                                      </div>
            ...
            <div class="div">
                ...
                <div class="form-group col-md-3">
                   ...
                   <label2>"""""""""</label2>
					...
					<button class="btn btn-danger" onclick="window.location.href = '/auaailatest/AUAAI/AUAAI/admin/admindashboard.php';">Cancel</button>
