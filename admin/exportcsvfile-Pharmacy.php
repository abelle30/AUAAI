...
$filename = "pharmacy_alumni_" . date('Y-m-d') . ".csv"; // Change the filename as per your preference
$delimiter = ",";
...
$result = mysqli_query($conn, "SELECT * FROM users WHERE Course = 'Bachelor of Science in Pharmacy' ORDER BY id DESC");
