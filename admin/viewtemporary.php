    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>View Alumni Tracer Record</b></h1>
            </div>
...
<div class="print-section" id="employment-record">
    <div class="card-header">Employment Record</div>

     <?php
    // Connect to your database (if not already connected)
    include('resources/includes/db_conn.php');  // Include your database configuration

    // Get the user ID from the URL
    if (isset($_GET['id'])) {
        $user_id = $_GET['id'];

        // Fetch the user's name based on the user ID
        $user_info_query = mysqli_query($conn, "SELECT name FROM alumnitracerform_data WHERE id = $user_id");
        $user_info = mysqli_fetch_assoc($user_info_query);

        // Check if the user exists
        if ($user_info) {
            echo "<h3>Record of : " . $user_info['name'] . "</h3>";

            // Modify the SQL query to group and display unique records
            $user_records_query = mysqli_query($conn, "SELECT company, date_employed, position, emp_status, salary
                FROM employmentrecord
                WHERE user_id = $user_id AND status = 1
                GROUP BY company, date_employed, position, emp_status, salary");

            if (mysqli_num_rows($user_records_query) > 0) {
                ?>
        <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped display" width="100%">
            <!-- ... Your existing table header ... -->
            <tbody>
            <?php
            while ($user_record = mysqli_fetch_array($user_records_query)) {
                echo "<tr>
                        <td>".$user_record['company']."</td>
                        <td>".$user_record['date_employed']."</td>
                        <td>".$user_record['position']."</td>
                        <td>".$user_record['emp_status']."</td>
                        <td>".$user_record['salary']."</td>
                      </tr>";
            }
            ?>
            </tbody>
     ...
     <?php
                ...
                echo "No employment records found for this user.";
            }
        } else {
            echo "User not found.";
        }
...
<!-- Masters Degree Record Section -->
<div class="print-section" id="masters-degree-record">
    <div id="heading-breadcrumbs">
        <div class="container">
            <div class="row d-flex align-items-center flex-wrap">
                <div class="col-md-7">
                    <h1 class="h2"><b>Masters Degree Record</b></h1>
                </div>
                <!-- ... Other elements ... -->
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="card-header">
                                <h2 class="alumniList">View Masters Degree</h2>
                            </div>
    ...
    if (isset($_GET['id'])) {
        ...
        if ($user_info) {
            ...
            $user_records_query = mysqli_query($conn, "SELECT * FROM degree WHERE user_id = $user_id AND degree_type = 1 AND status = 1");
    ...
    ?>
                                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped display" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        while ($user_record = mysqli_fetch_array($user_records_query)) {
                                            echo "<tr>
                                                    <td>".$user_record['course']."</td>
                                                    <td>".$user_record['school']."</td>
                ...
                echo "No Masters Degree records found for this user.";
            }
        } else {
            echo "User not found.";
        }
...
<div class="print-section" id="doctorate-degree-record">
    <div id="heading-breadcrumbs">
        <div class="container">
            <div class="row d-flex align-items-center flex-wrap">
                <div class="col-md-7">
                    <h1 class="h2"><b>Doctorate Degree Record</b></h1>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="card-header">
                                <h2 class="alumniList">View Doctorate Degree</h2>
                            </div>
    ...
    if (isset($_GET['id'])) {
        ...
        if ($user_info) {
            ...
            // Fetch all records for the specified user
            $user_records_query = mysqli_query($conn, "SELECT * FROM degree WHERE user_id = $user_id AND degree_type = 2 AND status = 1");
    ...
    ?>
                ...
                echo "No Doctorate Degree records found for this user.";
            }
        } else {
            echo "User not found.";
        }
...
<div class="print-section" id="licensure-exam-record">
    <div id="heading-breadcrumbs">
        <div class="container">
            <div class="row d-flex align-items-center flex-wrap">
                <div class="col-md-7">
                    <h1 class="h2"><b>Licensure Exam Record</b></h1>
                </div>
                <!-- ... Other elements ... -->
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="card-header">
                                <h2 class="alumniList">View Licensure Exam</h2>
                            </div>
    ...
    if (isset($_GET['id'])) {
        ...
        if ($user_info) {
            ...
            // Fetch all records for the specified user
            $user_records_query = mysqli_query($conn, "SELECT * FROM degree WHERE user_id = $user_id AND degree_type = 3 AND status = 1");
    ...
    ?>
                                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped display" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="text-center">Type of Licensure Exam</th>
                                            <th class="text-center">Year Passed</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                ...
                echo "No Licensure Exam records found for this user.";
            }
        } else {
            echo "User not found.";
        }
...
<!-- Current Employment Information Section -->
<div class="print-section" id="current-employment-info">
    <div id="heading-breadcrumbs">
        <div class="container">
            <div class="row d-flex align-items-center flex-wrap">
                <div class="col-md-7">
                    <h1 class="h2"><b>Current Employment Information</b></h1>
                </div>
                <!-- ... Other elements ... -->
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="card-header">
                                <h2 class="alumniList">View employment</h2>
                            </div>
	...
	$user_id = $_GET['id'];
	$queryy = "SELECT emp_status FROM alumnitracerform_data WHERE id = $user_id";
	$user_records_queryy = mysqli_query($conn, $queryy);

	if ($user_records_queryy) {
	    if (mysqli_num_rows($user_records_queryy) > 0) {
	        $rowy = mysqli_fetch_assoc($user_records_queryy);

	        $emp_status = $rowy['emp_status'];

	    } else {
	        echo "No records found for user ID: $user_id";
	    }
	} else {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($user_info) {
            ...
            // Fetch all records for the specified user
            $user_records_query = mysqli_query($conn, "SELECT * FROM alumnitracerform_data WHERE id = $user_id");
    ...
    ?>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <th class="text-center">Approximate Monthly Salary</th>
                                            <?php
                                            } else {
                                            ?>
                                                <th class="text-center">Employment Status</th>
                                                ...
                                                <th class="text-center">Role in Business</th>
                ...
                while ($user_record = mysqli_fetch_array($user_records_query)) {
                	...
                	if($user_record['emp_status'] == "employed") {
                		echo "<tr>
						    <td>".(!empty($user_record['emp_status']) ? $user_record['emp_status'] : '-----')."</td>
						    <td>".(!empty($user_record['current_job_position']) ? $user_record['current_job_position'] : '-----')."</td>
						    <td>".(!empty($user_record['company_affiliation']) ? $user_record['company_affiliation'] : '-----')."</td>
                            <td>".(!empty($user_record['company_address']) ? $user_record['company_address'] : '-----')."</td>
						    <td>".(!empty($user_record['job_industry_type']) ? $user_record['job_industry_type'] : '-----')."</td>
						    <td>".(!empty($user_record['monthly_salary']) ? $user_record['monthly_salary'] : '-----')."</td>
						</tr>";
                	}
                	else {
                		echo "<tr>
                		<td>".(!empty($user_record['emp_status']) ? $user_record['emp_status'] : '-----')."</td>
						    <td>".(!empty($user_record['name_of_business']) ? $user_record['name_of_business'] : '-----')."</td>
						    <td>".(!empty($user_record['nature_of_business']) ? $user_record['nature_of_business'] : '-----')."</td>
						    <td>".(!empty($user_record['role_in_business']) ? $user_record['role_in_business'] : '-----')."</td>
						    <td>".(!empty($user_record['business_address']) ? $user_record['business_address'] : '-----')."</td>
						    <td>".(!empty($user_record['business_phone_number']) ? $user_record['business_phone_number'] : '-----')."</td>
						    <td>".(!empty($user_record['business_approx_salary']) ? $user_record['business_approx_salary'] : '-----')."</td>
						</tr>";
                	}
    ...
    ?>
                ...
                echo "No Tracer Form records found for this user.";
            }
        } else {
            echo "User not found.";
        }
...
<!-- Other Tracer Form Info Section -->
<div class="print-section" id="other-tracer-form-info">
    <div id="heading-breadcrumbs">
        <div class="container">
            <div class="row d-flex align-items-center flex-wrap">
                <div class="col-md-12">
                    <h1 class="h2"><b>Other Tracer Form Info</b></h1>
                </div>
                <!-- ... Other elements ... -->
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="card-header">
                                <h2 class="alumniList">View other Info</h2>
                            </div>
    ...
    ?>
                                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped display" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="text-center">Employment Source</th>
                                            <th class="text-center">Is Job related to Course?</th>
                                            <th class="text-center">Employed within 6 months of graduation?</th>
                                            <th class="text-center">Job Satisfaction</th>
                                            <th class="text-center">Intend to stay on the current job?</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                while ($user_record = mysqli_fetch_array($user_records_query)) {
                    echo "<tr>
                            <td>".$user_record['emp_source']."</td>
                            <td>".$user_record['job_relate']."</td>
                            <td>".$user_record['emp_immediate']."</td>
                            <td>".$user_record['job_satisfaction']."</td>
                            <td>".$user_record['intend_to_stay']."</td>
                          </tr>";
                }
    ?>
                                    </tbody>
...
function printTable() {
    ...
    printWindow.document.write('<html><head><title>Print</title><style> @media print { .print-section { page-break-before: always; } }</style></head><body>');

    for (var i = 0; i < printSections.length; i++) {
        var section = printSections[i].cloneNode(true);
  
        printWindow.document.write(section.innerHTML);
        printWindow.document.write('<hr>'); // Add a separator
    }
