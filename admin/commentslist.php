...
if(isset($_GET['verify'])) {
    ...
    // Create a prepared statement to update the record
    $sql = "UPDATE comments SET status = 'Verified' WHERE id = ?";
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            // Successful update
            header("Location: commentslist.php"); // Redirect to the career management page
            $_SESSION['delmsg'] = "Comment approved!";
            exit();
        } else {
            // Error handling
...
if(isset($_GET['del']))
		  {
		          mysqli_query($conn,"delete from comments where id = '".$_GET['id']."'");
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Comments List</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList">Comments List</h2>
					</div>
...
<a title="Complete" href="commentslist.php?id=<?php echo $row['id']; ?>&verify=1"><i class="icon-edit">Verify</i></a>
    <a tittle="Delete" href="commentslist.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign">Delete</i></a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
