...
if(isset($_POST['submit']) && isset($_FILES['image']))
{
 $Name = $_POST['Name'];
	...
	$error = $_FILES['image']['error'];
        ...
        $sql = mysqli_query($conn, "INSERT officers SET 
    Name = '$Name',
    Position = '$Position',
    year = '$year',
    archive = '$archive',
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add Officer</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="addofficer" method="post" enctype="multipart/form-data">

				<div class="form-group col-md-3">
                    <label for="firstname"><b>Name</b></label>
                    <input type="upcomingevent" class="form-control2" id="Name" name="Name"  value="" required>
                </div>
                
                							
			<div class="form-group col-md-3">
                    <label for="firstname"><b>Position</b></label>
                    <input type="upcomingevent" class="form-control2" id="Position" name="Position"  value="" required>
                </div>
                
                
                  	<div class="form-group col-md-3">
                    <label for="firstname"><b>Year</b></label>
                     <input type="text" class="form-control2" id="year" name="year" pattern="\d{4}" title="Enter a valid 4-digit year" value="" required>
                </div>
                
                	
                    <input type="hidden" class="form-control2" id="archive" name="archive"  value="not-archived">
