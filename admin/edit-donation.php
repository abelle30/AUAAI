		...
		if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($conn,"select fname from donations where id='$pid'");
	$result=mysqli_fetch_row($query);

	$Msg = 'Donation Added!';
	
$sql=mysqli_query($conn,"UPDATE donations SET 
fname='$fname', lname='$lname', donationtype='$donationtype', usertype='$usertype'
   WHERE id = '$pid';
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Edit Donation</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="editdonation" method="post" enctype="multipart/form-data">

									
			<div class="form-group col-md-3">
                    <label for="firstname"><b>First name</b></label>
                    <input type="fname" class="form-control2" id="title" name="fname"  value="<?php echo htmlentities($row['fname']);?>" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Last name</b></label>
                    <input type="lname" class="form-control2" placeholder="" value="<?php echo htmlentities($row['lname']);?>"  id="lname" name="lname">
                </div>

                <div class="form-group col-md-3">
                    <label for="lastname"><b>Donation type</b></label>
                    
                    <div class="form-check">
                                        <input type="radio"  name="donationtype" id="donationtype" value="cash">
                                        <label name="donationtype">
                                          Cash
                                        </label>
                                        
                                      </div>
                                      <div class="form-check">
                                        <input type="radio" name="donationtype" id="donationtype" value="goods">
                                        <label  name="donationtype">
                                          Goods
                                        </label>
                                      </div>                 
                ...
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Usertype</b></label>
