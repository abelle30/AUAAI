...
$sql=mysqli_query($conn,"insert donations SET 
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add Announcement</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="edituser" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    ...
                    <input type="fname" class="form-control2" id="title" name="fname"  value="" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Last name</b></label>
                    <input type="lname" class="form-control2" placeholder="" value=""  id="lname" name="lname">
                </div>
            ...
            <div class="div">
                ...
                <div class="form-group col-md-3">
                   ...
                   <label2>"""""""""</label2>
						...
						<button class="btn btn-danger" onclick="window.location.href = '/admin/manage-donation.php';">Cancel</button>
