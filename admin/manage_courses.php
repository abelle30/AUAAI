...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["new_course"])) {
        ...
        $sql = "INSERT INTO courses (course_name) VALUES ('$newCourse')";
        ...
        $sql = "UPDATE courses SET course_name='$editedCourseName' WHERE id='$editCourseId'";
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add New Course</b></h1>
            </div>
            </ul>
            </div>
        </div>
...
<div class="card">
    ...
    <div class="card-header">
        <h2 class="alumniList">Add A Course</h2>
    </div>


    <br>

    <form class="form-horizontal row-fluid" name="addalumniid" method="post" action="manage_courses.php">
    <div class="row">
        <div class="col-lg-5">
            <div class="flex-container">
                <div class="flex-item">
                    <div class="form-group col-md-3">
                        <label for="new_course"><b>New Course:</label>
                        <input type="text" name="new_course" class="form-control" required>
                        <br>
                    </div>

                    <div class="form-group col-md-100"> <!-- Adjust col-md-12 to your desired width class -->
                        <button class="btn btn-primary" style="margin-left: 20px !important;" type="submit">Add Course</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Courses</b></h1>
            </div>
            </ul>
            </div>
        </div>
...
$query = mysqli_query($conn, "SELECT DISTINCT id, course_name FROM courses");
...
<td>
                <a title="View Details" href="editcourse.php?id=<?php echo $row['id']; ?>">Edit</a>
            </td>
