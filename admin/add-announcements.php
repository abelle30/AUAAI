...
$sql=mysqli_query($conn,"insert announcements SET 
...
<form class="form-horizontal row-fluid" name="edituser" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    ...
                    <input type="title" class="form-control2" id="title" name="fname"  value="" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Published Date</b></label>
                    <input type="date" class="form-control" placeholder="" value=""  id="postdate" name="postdate"  style="border-radius: 20px; width: 170px">
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Content</b></label>
                    <textarea class="summernote" id="content" name="content" value="" required></textarea>
                </div>
