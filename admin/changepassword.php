...
if(isset($_POST['submit'])) {
    if(isset($_POST["email"]) && isset($_POST['current_password']) && isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
        ...
        $query = mysqli_query($conn, "SELECT password FROM users WHERE id='1'");
        ...
        if ($result) {
            ...
            if ($current_password === $stored_password) {
                if ($new_password === $confirm_password) {
                    ...
                    $sql = mysqli_query($conn, "UPDATE users SET password='$new_password' WHERE id='1'");
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Change Password</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Strong password required. Enter more than 8 characters. Do not include common words or name. Combine uppercase letters, lowercase letters, numbers, and symbols. </h2>
					</div>
...
?>
                                   ...
                                   <form class="form-horizontal row-fluid" name="changepassword" method="post" enctype="multipart/form-data">

<input type="hidden" name="email"  id="email" value="<?php echo htmlentities($row['email']);?>">
<input type="hidden" name="email"  id="email" value="<?php echo htmlentities($row['password']);?>">		
<?php } ?>		
			<div class="form-group col-md-3">
                    <label for="firstname"><b>Current Password</b></label>
                    <input type="password" class="form-control2" id="current_password" name="current_password"  value="" required>
                </div>


                <div class="form-group col-md-3">
                    <label for="lastname"><b>New Password</b></label>
                    <input type="password" class="form-control2" id="new_password" name="new_password" value="" required>
                </div>

                <div class="form-group col-md-3">
                    <label for="lastname"><b>Retype Password</b></label>
                    <input type="password" class="form-control2" id="confirm_password" name="confirm_password" value="" required>
                </div>
                ...
                <div class="form-group col-md-9">
					...
					<button class="btn btn-danger" onclick="window.location.href = '/admin/admindashboard.php';">Cancel</button>
