...
$date=$_POST['$date'];
	...
	$query=mysqli_query($conn,"select * from mentorship where id='$pid'");
	$result=mysqli_fetch_row($query);
	


    $sql=mysqli_query($conn, "UPDATE mentorship SET 
  

   PostTitle='$PostTitle',
PostImage = '$new_img_name',
...
"); 
 ...
 $_SESSION['msg'] = "Mentorship updated!";
?>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add Mentorship</b></h1>
            </div>
...
<?php } ?>
                   ...
                   $query = mysqli_query($conn, "SELECT
                    ...
                    mentorship.PostImage,
                    mentorship.CategoryName,
...
<form class="form-horizontal row-fluid" name="addalumniid" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    ...
                    <input type="PostTitle" class="form-control2" id="PostTitle" name="PostTitle"  value="<?php echo htmlentities($row['PostTitle']);?>" required>
                </div>


                <div class="form-group col-md-3">
                    <label for="lastname"><b>Category Name</b></label>
                    <input type="CategoryName" class="form-control2" id="CategoryName" name="CategoryName" value="<?php echo htmlentities($row['CategoryName']);?>" required>
                </div>
...
if (isset($row['PostImage'])) {
    ...
    $PostImage = 'default_image.jpg'; // Provide a default image or handle it as needed
}

if (isset($row['title2'])) {
    $title2 = htmlentities($row['title2']);
} else {
    // Handle the case where 'title' key is not present in the array
    $title2 = 'Default Title'; // Provide a default title or handle it as needed
}
?>

                <div class="form-group col-md-3">
<td><label class="esignature" style="color: black;">Image</label></td>
...
<img src="/admin/resources/images/<?php echo $postImage; ?>" id="PostImage" name="PostImage" class="img-fluid rounded-start" width="900px" height="650px">
...
<div class="form-group col-md-3">
                    ...
                    <textarea class="summernote" id="description" name="description"  value="" required><?php echo htmlentities($row['description']);?></textarea>
                </div>

               
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Date</b></label>
                    <input type="date" class="form-control" placeholder=""  value="<?php echo htmlentities($row['date']);?>" id="date" name="date"  style="border-radius: 20px; width: 170px">
                </div>
...
<script>
    function cancelForm() {
        window.location.href = 'https://auaaiconnect.online/admin/manage-mentorship.php';
    }
