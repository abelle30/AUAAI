...
state='$state', city='$city', street='$street', usertype='$usertype', status='$status'
WHERE id='$pid'");
    ...
    if ($query) {
        ...
        if ($row) {
            // Set the subject and message variables
            $subject = $row['subject'];
            $message = $row['message'];
              $headers = "From: noreply@auaaiconnect.online";
            ...
            $_SESSION['error'] = "No data found in the database for the specified ID.";
        }
    } else {
        $_SESSION['error'] = "Database query failed. Please try again later.";
    }
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Alumni Information (Verification)</b></h1>
            </div>
...
{?>
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">×</button>
										        <script>alert("User Verified Successfully!")</script>
									</div>
<?php } ?>
									<br />
...
<form class="form-horizontal row-fluid" name="edituser" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    ...
                    <input type="fname" class="form-control2" id="fname" name="fname"  value="<?php echo htmlentities($row['fname']);?>" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label for="lastname"><b>Middle name</b></label>
                    <input type="mname" class="form-control2" id="mname" name="mname" value="<?php echo htmlentities($row['mname']);?>" readonly>
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Last name</b></label>
                    <input type="lname" class="form-control2" id="lname" name="lname" value="<?php echo htmlentities($row['lname']);?>"  readonly>
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Suffix</b></label>
                    <input type="suffix" class="form-control2" id="suffix" name="suffix" value="<?php echo htmlentities($row['suffix']);?>"  readonly>
                </div>

				<div class="form-group col-md-3">
                    <label for="email"><b>Nationality</b></label>
                    <input type="nationality" class="form-control2" id="nationality" name="nationality" value="<?php echo htmlentities($row['nationality']);?>"readonly>
                </div>


				<div class="form-group col-md-4"> <!-- Adjust col-md-4 to your desired width class -->
    <label for="mobileno"><b>Year Graduated</b></label>
    <div class="form-group row">
        <div class="col-md-2"> <!-- Adjust col-md-2 to your desired width class -->
        <input type="year" class="form-control2" id="year" name="year" value="<?php echo htmlentities($row['year']);?> " readonly >
        </div>
    </div>
</div>


<label for="mobileno"><b>Course</b></label>
<div class="col-md-5">
                              
                             
<input type="year" class="form-control2" id="course" name="course" value="<?php echo htmlentities($row['course']);?> " readonly >
                ...
                <input type="year" class="form-control2" id="civilstatus" name="civilstatus" value="<?php echo htmlentities($row['civilstatus']);?> " readonly >
...
<div class="form-group col-md-3">
				...
				<label for="mobileno"><b>Gender</b></label>

                <input type="year" class="form-control2" id="gender" name="gender" value="<?php echo htmlentities($row['gender']);?> " readonly >
				...
				<div class="form-group col-md-3">
                    ...
                    <input type="email" class="form-control2" id="email" name="email" value="<?php echo htmlentities($row['email']);?>"  readonly>
                </div>

				<div class="form-group col-md-3">
                    <label for="email"><b>Password</b></label>
                    <input type="password" class="form-control2" id="password" name="password"  value="<?php echo htmlentities($row['password']);?>" readonly>
                </div>

				<div class="form-group col-md-3">
                    <label for="mobileno"><b>Mobile number</b></label>
                    <input type="mobileno" class="form-control2" id="mobileno" name="mobileno"  value="<?php echo htmlentities($row['mobileno']);?>" readonly>
                </div>
                    ...
                    <input type="lot" class="form-control2" id="lot" name="lot" value="<?php echo htmlentities($row['lot']);?>"  readonly>
                </div>
				<div class="form-group col-md-3">
				<label for="lot"><b>Street</b></label>
                    <input type="street" class="form-control2" id="street" name="street"  value="<?php echo htmlentities($row['street']);?>" readonly>
                </div>
				<div class="form-group col-md-3">
				<label for="lot"><b>City</b></label>
                    <input type="city" class="form-control2" id="city" name="city" value="<?php echo htmlentities($row['city']);?>"  readonly>
                </div>


		<div class="form-group col-md-3">
                    <label for="state"><b>State</b></label>
                    <input type="state" class="form-control2" id="state" name="state"  value="<?php echo htmlentities($row['state']);?>" readonly>
                </div>

				   <input type="hidden" class="form-control2" id="usertype" name="usertype" value="alumni">
				   <input type="hidden" class="form-control2" id="status" name="status" value="verified">
...
<script>
    function cancelForm() {
        window.location.href = 'https://auaaiconnect.online/admin/verifylist.php';
    }
