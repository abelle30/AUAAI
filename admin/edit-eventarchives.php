...
$sql=mysqli_query($conn,"UPDATE events SET 
PostTitle = '$PostTitle',
...
WHERE id = '$pid'");
 ...
 $_SESSION['msg'] = "Event archive updated!";
?>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Edit Event Archives</b></h1>
            </div>
...
<?php } ?>
                   ...
                   events.id as postid,
                   events.PostImage as PostImage,
                   events.PostTitle as title,
                   events.description,
                   events.Location,
                   category.CategoryName as category,
                   category.id as catid,
                   events.SubCategoryId as subcatid
               FROM events
               LEFT JOIN category ON category.id = events.CategoryId
               WHERE events.id = '$pid' AND events.Is_Active = 1");
...
<form class="form-horizontal row-fluid" name="editpost" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    <label for="firstname"><b>Post Title</b></label>
                    <input type="PostTitle" class="form-control2" id="PostTitle" name="PostTitle"  value="<?php echo htmlentities($row['title']);?>" required>
                </div>
...
<?php } ?>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="Location" class="form-control2" id="Location" name="Location" value="<?php echo htmlentities($row['Location']);?>" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Date</b></label>
                    <input type="date" class="form-control2" id="SubCategoryId" name="SubCategoryId" value="<?php echo htmlentities($row['subcatid']);?>" required>
                </div>
...
<img src="/admin/resources/images/<?php echo $postImage; ?>" id="PostImage" name="PostImage" class="img-fluid rounded-start" width="200" height="150">
<input type="file" name="PostImage" id="PostImage" />  
     ...
     <input type="hidden" name="existing_image" value="<?php echo htmlentities($row['PostImage']); ?>">
...
<script>
    function cancelForm() {
        window.location.href = 'https://auaaiconnect.online/admin/manageeventsarchive.php';
    }
