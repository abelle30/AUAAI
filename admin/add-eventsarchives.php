...
$sql=mysqli_query($conn,"INSERT events SET 
PostTitle = '$PostTitle',
...
$_SESSION['msg']="Event archive added!";
?>
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add Event Archive</b></h1>
            </div>
...
<?php } ?>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="Location" class="form-control2" id="Location" name="Location" value="" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="email"><b>Date</b></label>
                    <input type="date" class="form-control2" id="SubCategoryId" name="SubCategoryId" value="" required>
                </div>
            ...
            <div class="div">
                ...
                <div class="form-group col-md-3">
                   ...
                   <label2>"""""""""</label2>
					...
					<button class="btn btn-danger" onclick="window.location.href = '/admin/manageeventsarchive.php';">Cancel</button>
