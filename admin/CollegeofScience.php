    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>College of Science</b></h1>
            </div>
...
<a tittle="Edit Details" href="view-users.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">View</i></a>
    <!--<a tittle="Delete" href="CollegeofScience.php?id=  &del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign">Delete</i></a>-->
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
...
<!-- Import & Export link -->
            ...
            <a href="exportcsvfile-Science.php" class="btn btn-primary"><i class="exp"></i> Export CSV file</a>
       
    <!-- CSV file upload form -->
    <div class="col-md-12" id="importFrm" style="display: none;">
        <form action="importcsvfile-Science.php" method="post" enctype="multipart/form-data">
