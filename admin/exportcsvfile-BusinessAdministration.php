...
$filename = "architecture_alumni_" . date('Y-m-d') . ".csv"; // Change the filename as per your preference
$delimiter = ",";
...
$result = mysqli_query($conn, "SELECT * FROM users WHERE course IN ('Bachelor of Science in Accountancy', 'Bachelor of Science in Business Administration Major in Financial Management', 'Bachelor of Science in Business Administration Major in Marketing Management', 'Bachelor of Science in Business Administration Major in Operations Management', 'Bachelor of Science in Customs Administration', 'Bachelor of Science in Hospitality Management') ORDER BY id DESC");
