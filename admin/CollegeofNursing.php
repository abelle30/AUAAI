    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>College of Nursing</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<?php
$query = mysqli_query($conn, "SELECT * FROM users where course = 'Bachelor of Science in Nursing';");
$cnt = 1;
...
<a tittle="Edit Details" href="view-users.php?id= <?php echo $row['id']; ?>"><i class="icon-edit">View</i></a>
    <!--<a title="Delete" href="CollegeofNursing.php?id=   &del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign">Delete</i></a>-->
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
 ...
 <!-- Import & Export link -->
            ...
            <a href="exportcsvfile-Nursing.php" class="btn btn-primary"><i class="exp"></i> Export CSV file</a>
       
    <!-- CSV file upload form -->
    <div class="col-md-12" id="importFrm" style="display: none;">
        <form action="importcsvfile-Nursing.php" method="post" enctype="multipart/form-data">
