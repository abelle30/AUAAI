...
if(isset($_POST['submit'])) {
    if(isset($_SESSION["email"]) && isset($_POST['current_password']) && isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
        ...
        if ($result) {
            ...
            if ($current_password === $stored_password) {
                if ($new_password === $confirm_password) {
                    $sql = mysqli_query($conn, "UPDATE users SET password='$new_password' WHERE email='$email'");
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
					 Strong password required. Enter more than 8 characters. Do not include common words or name. Combine uppercase letters, lowercase letters, numbers, and symbols. 
					</div>
