...
<td>
   <a title="Archive" href="manage-officer.php?archive=1&officerID=<?php echo $row['officerID']; ?>"><i class="icon-edit">Archive</i></a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['Description']; ?></td>
                        <td>
                            <a title="unarchive" href="manage-officer.php?unarchive=1&officerID=<?php echo $row['officerID']; ?>">Unarchive</a>
