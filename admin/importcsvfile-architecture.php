...
if (isset($_POST['importSubmit'])) {
    ...
    // Check whether user already exists in the database with the same id and the selected course
    $prevQuery = "SELECT id FROM users WHERE id = '" . $conn->real_escape_string($id) . "' AND Course = '" . $conn->real_escape_string($Course) . "'";
