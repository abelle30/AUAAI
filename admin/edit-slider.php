...
if(isset($_POST['submit']) && isset($_FILES['image']) && isset($_FILES['image2']) && isset($_FILES['image3']))
{
...
$error = $_FILES['image3']['error'];
    ...
    $sql=mysqli_query($conn, "UPDATE slider SET 
    image='$new_img_name',
   
image2='$new_img_name2',
   image3='$new_img_name3'
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Edit User Home Slider</b></h1>
            </div>
...
while ($row = mysqli_fetch_array($query)) {
    ...
    // Process each image
    $image = isset($row['image']) ? htmlentities($row['image']) : 'default_image.jpg';
    $image2 = isset($row['image2']) ? htmlentities($row['image2']) : 'default_image.jpg';
    $image3 = isset($row['image3']) ? htmlentities($row['image3']) : 'default_image.jpg';

    ?>

    <form class="form-horizontal row-fluid" name="editslider" method="post" enctype="multipart/form-data">
...
if (isset($row['image'])) {
    $postImage = htmlentities($row['image']);
} else {
...
if (isset($row['image2'])) {
    $postImage = htmlentities($row['image2']);
} else {
    // Handle the case where 'PostImage' key is not present in the array
    $postImage = 'default_image.jpg'; // Provide a default image or handle it as needed
}
...
if (isset($row['image3'])) {
    $postImage = htmlentities($row['image3']);
} else {
    // Handle the case where 'PostImage' key is not present in the array
    $postImage = 'default_image.jpg'; // Provide a default image or handle it as needed
}
...
?>
        ...
        <div class="form-group col-md-3">
            <label for="image1"><b>1st Image</b></label>
        </div>
        <div class="form-group col-md-3">
            <img src="/admin/resources/images/<?php echo $image; ?>" id="image1" name="image1" class="img-fluid rounded-start" width="200" height="150">
            <input type="file" name="image" id="image" />
        </div>

        <div class="form-group col-md-3">
            <label for="image2"><b>2nd Image</b></label>
        </div>
        <div class="form-group col-md-3">
            <img src="/admin/resources/images/<?php echo $image2; ?>" id="image2" name="image2" class="img-fluid rounded-start" width="200" height="150">
            <input type="file" name="image2" id="image2" />
        </div>

        <div class="form-group col-md-3">
            <label for="image3"><b>3rd Image</b></label>
        </div>
        <div class="form-group col-md-3">
            <img src="/admin/resources/images/<?php echo $image3; ?>" id="image3" name="image3" class="img-fluid rounded-start" width="200" height="150">
            <input type="file" name="image3" id="image3" />
        </div>

        <input type="hidden" name="existing_image1" value="<?php echo $image1; ?>">
        <input type="hidden" name="existing_image2" value="<?php echo $image2; ?>">
        <input type="hidden" name="existing_image3" value="<?php echo $image3; ?>">
...
<?php if(!empty($msg)){ ?>
<div class="col-xs-12">
    <div class="alert <?php echo $msg; ?>"><?php echo $msg; ?></div>
</div>
<?php } ?>
