		...
		if(isset($_POST['submit'])  && isset($_FILES['PostImage']))
{
	...
	$error = $_FILES['PostImage']['error'];
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                $_SESSION['msg']="mentorship added!";
	

    $sql=mysqli_query($conn, "INSERT mentorship SET 
...
<form class="form-horizontal row-fluid" name="addalumniid" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                    ...
                    <input type="PostTitle" class="form-control2" id="PostTitle" name="PostTitle"  value="" required>
                </div>


                <div class="form-group col-md-3">
                    <label for="lastname"><b>Category Name</b></label>
                    <input type="CategoryName" class="form-control2" id="CategoryName" name="CategoryName" value="" required>
                </div>
...
<div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control" placeholder="" value=""  id="date" name="date"  style="border-radius: 20px; width: 170px">
                </div>
                         

<div class="form-group col-md-3">
                    <label for="message"><b>Message</b></label>
                    <textarea class="summernote" id="description" name="description" value="" required></textarea>
                </div>
                ...
                <div class="form-group col-md-9">
					...
					<button class="btn btn-danger" onclick="window.location.href = '/admin/manage-mentorship.php';">Cancel</button>
