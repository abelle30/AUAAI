...
exit();
    ...
    if(isset($_GET['del']) && isset($_GET['id'])) {
        ...
        $_SESSION['delmsg'] = "Event with ID $id deleted!";
            ...
            // if(isset($_GET['proid']))
            // {
            //     $alumniid_id = $_GET['proid'];
            //     $sql = "UPDATE alumniid SET status = 0 WHERE id = $alumniid_id";
            //     if (mysqli_query($conn, $sql)) {
            //         // Successful update
            //         header("Location: pending-alumniid.php"); // Redirect to the alumni id management page
            //         exit();
            //     } else {
            //         // Error handling
            ...
            // if(isset($_GET['comid']))
            // {
            //     $alumniid_id = $_GET['comid'];
            //     $sql = "UPDATE alumniid SET status = 2 WHERE id = $alumniid_id";
            //     if (mysqli_query($conn, $sql)) {
            //         // Successful update
            //         header("Location: pending-alumniid.php"); // Redirect to the alumni id management page
            //         exit();
...
<div class="logo-src">
  ...
  <a href="admindashboard.php" class="navlogo-item"><center> </i></span> Dashboard</a></center> 
        ...
        <div class="container">
            <div class="row d-flex align-items-center flex-wrap">
                <div class="col-md-7">
                    ...
                    <h1 class="h2"><b>Completed List of Alumni ID</b></h1>
                </div>
        ...
        <div class="card-body">
                ...
                <div class="container">
                        ...
                        <div class="card-header">
                            <h2 class="alumniList"> Pending Alumni ID </h2>
    ...
    <td>
        <!---MARK--->
    <!-- <a title="Processing" href="pending-alumniid.php?proid=<?php echo htmlentities ($row['id']); ?>"><i class="icon-edit">Processing</i></a>
    <a title="Completed" href="pending-alumniid.php?comid=<?php echo  htmlentities ($row['id']); ?>"><i class="icon-edit">Completed</i></a> -->

    <a title="Completed">Completed</i></a>
