        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card"  > 
                    <div class="card-body "> 
                        ...
                        <center> <img src="resources/images/architecture.png" class="nav-avatar3" /> 
                        <a href="CollegeofArchitecture.php" class="nav-item nav-gallery"><span class='icon-field'></span> College of Architecture</a>
                      </center>
            ...
            <div class="col-md-3"> 
                <div class="card">
                    <div class="card-body ">
                        <div class="card-body text-black">
                        <center><img src="resources/images/ba.png" class="nav-avatar3" /> 
                        <a href="CollegeofBusinessAdministration.php" class="nav-item nav-gallery"><span class='icon-field'></span> College of Business Administration</a>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body ">
                        <div class="card-body text-black">
                        <center><img src="resources/images/liberalarts.png" class="nav-avatar3" /> 
                    
                        <a href="CollegeofEducationLiberalArts.php" class="nav-item nav-gallery"><span class='icon-field'></span>College of Education & Liberal Arts</a>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="card-body text-black">
                        <center><img src="resources/images/engineering.png" class="nav-avatar3" /> 
                 
                        <a href="CollegeofEngineering.php" class="nav-item nav-gallery"><span class='icon-field'></span>College of Engineering</a>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body ">
                        <div class="card-body text-black">
                        <center><img src="resources/images/law.png" class="nav-avatar3" /> 
               
                        <a href="CollegeofLaw.php" class="nav-item nav-gallery"><span class='icon-field'></span>College of Law</a>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body ">
                        <div class="card-body text-black">
                        <center>  <img src="resources/images/nursing.png" class="nav-avatar3" /> 
    
                        <a href="CollegeofNursing.php" class="nav-item nav-gallery"><span class='icon-field'></span>College of Nursing</a>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body ">
                        <div class="card-body text-black">
                        <center><img src="resources/images/pharmacy.png" class="nav-avatar3" /> 
            
                        <a href="CollegeofPharmacy.php" class="nav-item nav-gallery"><span class='icon-field'></span>College of Pharmacy</a>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body ">
                        <div class="card-body text-black">
                        <center><img src="resources/images/science.png" class="nav-avatar3" /> 
                    
                        <a href="CollegeofScience.php" class="nav-item nav-gallery"><span class='icon-field'></span>College of Science</a>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body ">
                        <div class="card-body text-black">
                        <center><img src="resources/images/graduateschool.png" class="nav-avatar3" /> 
                        <a href="GraduateSchool.php" class="nav-item nav-gallery"><span class='icon-field'></span>Graduate School</a>
