		  ...
		  if(!empty($_GET['status'])){
			switch($_GET['status']){
                ...
                if($_GET['appid'])
                {
                    ...
                    $query=mysqli_query($con,"update careers set status='1' where id='$id'");
                    $msg="Career Posting Request Form Approved";
                }
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Careers</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Career Opportunities List </h2>
					</div>
...
$query = mysqli_query($conn, "SELECT careers.id AS id, careers.companyname AS companyname, careers.companyemailaddress AS email, 
                              careers.opportunitytype AS opportunitytype, careers.companyfieldindustry AS companyfieldindustry 
                              FROM careers");
...
<td><?php echo htmlentities ($row['opportunitytype']); ?></td>  
<td><?php echo htmlentities ($row['companyfieldindustry']); ?></td> 
<td>
<a title="Edit Details" href="edit-career.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
<a title="Remove Careers" href="manage-careers.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
<a title="Add Careers" href="approve-career.php?id=<?php echo $row['id']; ?>&add=add" onClick="return confirm('Are you sure you want to add this form?')">Approve</a>
</td>
</tr>  
<?php $cnt++;
} ?>	
