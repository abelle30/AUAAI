...
{
echo "<script>alert('Invalid format. Only jpg / jpeg/ png /gif /JPG /JPEG /PNG format allowed');</script>";
...
$query=mysqli_query($con,"update events set PostImage='$imgnewfile' where id='$id'");
if($query)
{
