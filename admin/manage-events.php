...
if(isset($_GET['del']) && isset($_GET['id'])) {
    $id = $_GET['id'];
    mysqli_query($conn, "DELETE FROM upcomingevents WHERE id = '$id'");
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Events</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList">Events List</h2>
					</div>
...
$query = mysqli_query($conn, "SELECT upcomingevents.id AS id, upcomingevents.upcomingevent AS upcomingevent, upcomingevents.info AS info, 
                              upcomingevents.place AS place, upcomingevents.date AS date, upcomingevents.image AS image, upcomingevents.description AS description 
                              FROM upcomingevents 
                         ");
...
<td><?php echo $row['upcomingevent']; ?></td>  
<td><?php echo $row['info']; ?></td>  
<td><?php echo $row['place']; ?></td>  
<td><?php echo $row['date']; ?></td> 
<td><?php echo $row['description']; ?></td> 
<td>
<a tittle="Edit Details" href="edit-events.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
<a tittle="Remove Products" href="manage-events.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
