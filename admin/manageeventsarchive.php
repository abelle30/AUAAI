    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Events Archive</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Events Archive List </h2>
					</div>
...
$query = mysqli_query($conn, "SELECT events.id AS id, events.PostTitle AS title,events.SubCategoryId,category.CategoryName AS category, 
                              subcategory.Subcategory AS subcategory, events.PostingDate AS postingdate, events.PostImage AS image 
                              FROM events 
...
<td>
<a tittle="Edit Details" href="edit-eventarchives.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
<a tittle="Remove Products" href="manageeventsarchive.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
