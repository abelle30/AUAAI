...
if (isset($_POST['submit']) && isset($_FILES['image'])) {
   $newstitle = $_POST['newstitle'];
    ...
    $query = mysqli_query($conn, "SELECT * FROM newsandannouncements WHERE id='$pid'");
    $result = mysqli_fetch_row($query);

    $sql = mysqli_query($conn, "UPDATE newsandannouncements SET 
        newstitle = '$newstitle',
    ...
    if ($sql) {
        ...
        $_SESSION['msg'] = "News update failed!";
    }
}
?>
...
<div class="container">
    ...
    $query = mysqli_query($conn, "SELECT
                                      newsandannouncements.id,
                                      newsandannouncements.newstitle,
                                      newsandannouncements.newsdescription,
                                      newsandannouncements.author,
                                      newsandannouncements.date,
                                      newsandannouncements.image,
                                      newsandannouncements.typeid
    ...
    ?>
        ...
        <form class="form-horizontal row-fluid" name="editpost" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control2" id="newstitle" name="newstitle" value="<?php echo htmlentities($row['newstitle']); ?>" required>
            </div>

            <div class="form-group col-md-3">
                <label for="lastname"><b>Author</b></label>
                <input type="text" class="form-control2" id="author" name="author" value="<?php echo htmlentities($row['author']); ?>" required>
            </div>

            <div class="form-group col-md-3">
                <label for="lastname"><b>Type</b></label>
                <input type="text" class="form-control2" id="typeid" name="typeid" value="<?php echo htmlentities($row['typeid']); ?>" required>
            </div>
            ...
            <img src="resources/images/<?php echo htmlentities($row['image']); ?>" id="new_img_name" name="new_img_name" alt="<?php echo htmlentities($row['image']); ?>" class="img-fluid rounded-start">
            <br>
            <input type="file" name="image" id="image" />

            <div class="form-group col-md-3">
                <label for="email"><b>Description</b></label>
                <textarea class="summernote" id="newsdescription" name="newsdescription" required><?php echo htmlentities($row['newsdescription']); ?></textarea>
            </div>
              </div>
<div class="container">
    <div class="row">
