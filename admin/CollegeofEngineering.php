    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>COLLEGE OF ENGINEERING</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Alumni List </h2>
					</div>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<?php
$query = mysqli_query($conn, "SELECT * FROM users WHERE course IN (
...
<td>
<a tittle="Edit Details" href="view-users.php?id= <?php echo $row['id']; ?>"><i class="icon-edit">View</i></a>
    <!--<a title="Delete" href="CollegeofEngineering.php?id=   &del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign">Delete</i></a>-->
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
   ...
   <!-- Import & Export link -->
            ...
            <a href="exportcsvfile-Engineering.php" class="btn btn-primary"><i class="exp"></i> Export CSV file</a>
       
    <!-- CSV file upload form -->
    <div class="col-md-12" id="importFrm" style="display: none;">
        <form action="importcsvfile-Engineering.php" method="post" enctype="multipart/form-data">
