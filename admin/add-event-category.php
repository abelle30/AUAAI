...
$sql=mysqli_query($conn,"INSERT categoryevents SET 
CategoryName = '$CategoryName',
Description = '$Description'

");

				$_SESSION['msg']="Event category added!";
			}
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add Event Category</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="addeventcategory" method="post" enctype="multipart/form-data">

									
			<div class="form-group col-md-3">
                    <label for="firstname"><b>Category</b></label>
                    <input type="upcomingevent" class="form-control2" id="CategoryName" name="CategoryName"  value="" required>
