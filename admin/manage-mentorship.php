...
if(isset($_GET['del']))
		  {
		          mysqli_query($conn,"delete from mentorship where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="mentorship deleted !";
		  }
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Mentorships</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Manage News </h2>
					</div>
...
$query = mysqli_query($conn, "SELECT mentorship.id AS id, mentorship.PostTitle AS PostTitle,
                              mentorship.PostImage AS PostImage, mentorship.CategoryName AS CategoryName,  
                              mentorship.description AS description,   mentorship.date AS date
                              FROM mentorship");
...
<td><img src="resources/images/<?php echo  $row['PostImage']; ?>" class="img-fluid rounded-start"></td>  
<td><?php echo $row['CategoryName']; ?></td>  
<td><?php echo $row['description']; ?></td> 
<td><?php echo $row['date']; ?></td> 
<td>
<a tittle="Edit Details" href="edit-mentorship.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
<a tittle="Remove Products" href="manage-mentorship.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
