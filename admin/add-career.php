...
$sql=mysqli_query($conn,"insert careers SET 
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Add a Career Opportunity</b></h1>
            </div>
...
<form class="form-horizontal row-fluid" name="addcareer" method="post" enctype="multipart/form-data">
			...
			<div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="companyemailaddress" class="form-control2" id="companyemailaddress" name="companyemailaddress" value="" required>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="contactno" class="form-control2" id="contactno" name="contactno" value=""  required>
                </div>

				<div class="form-group col-md-3">
                    <label for="email"><b>Contact person</b></label>
                    <input type="contactperson" class="form-control2" id="contactperson" name="contactperson" value=""  required>
                </div>
...
<select id="opportunitytype" name="opportunitytype">
				...
				<div class="form-group col-md-3">
                    ...
                    <textarea class="summernote" id="message" name="message" value="" required></textarea>
                </div>
