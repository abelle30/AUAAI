    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Verification List</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<?php
$query = mysqli_query($conn, "SELECT * FROM users WHERE status = 'unverified'");
...
<td>
<a tittle="Edit Details" href="verify-user.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">View</i></a>
    <!--<a tittle="Delete" href="verifylist.php?id=  &del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign">Delete</i></a>-->
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
