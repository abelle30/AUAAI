    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage Emails</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> Email List </h2>
					</div>
...
$query = mysqli_query($conn, "SELECT emaildb.id, emaildb.subject,
                              emaildb.message
...
<td>
<a tittle="Edit Details" href="edit-email.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
