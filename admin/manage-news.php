...
if(isset($_GET['del']))
		  {
		          mysqli_query($conn,"delete from newsandannouncements where id = '".$_GET['id']."'");
    ...
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                ...
                <h1 class="h2"><b>Manage News</b></h1>
            </div>
    ...
    <div class="card-body">
			...
			<div class="container">
					...
					<div class="card-header">
						<h2 class="alumniList"> News List</h2>
					</div>
...
$query = mysqli_query($conn, "SELECT newsandannouncements.id AS id, newsandannouncements.newstitle AS title,
                              newsandannouncements.author AS author, newsandannouncements.date AS postdate,  
                              newsandannouncements.typeid AS type
...
<td>
<a tittle="Edit Details" href="edit-news.php?id=<?php echo $row['id']; ?>"><i class="icon-edit">Edit</i></a>
<a tittle="Remove Products" href="manage-news.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
</td>
</tr>  
<?php $cnt = $cnt + 1;
} ?>	
