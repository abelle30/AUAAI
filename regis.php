...
$error=0;
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['sign-up'])) {
  ...
  $hashedPassword = md5($password);
    ...
    if ($query) {
        ...
        if ($row) {
            ...
            if (mail($email, $subject, $message, $headers)) {
                ...
                echo "<script>alert('Thank you for your registration! An email will be sent to you confirming your registration is completed.  Our administration team will now review your account, and this process may take up to 24 hours. Additionally, please keep an eye on your email, as we will send you a confirmation message once your account has been verified. We appreciate your patience.');</script>";
    ...
    // You might want to log the error or set a session variable to display an error message to the user
}
}
}
            ...
            <div class="container rounded bg-white mt-5 mb-2">
                <div class="row">
                    <div class="col-md-2 border-right">
                        <div class="d-flex flex-column align-items-center text-center p7 py-2">
                    ...
                    <form id="validate_form" action= "regis.php" method="post">
                    <div class="card" style="width: 50rem;">
                        <div class="card-header h4" style="background-color: #5b9aff;">Fill Registration Form</div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="email" class="form-control" placeholder="Ex. sample.email@gmail.com" name="email" id="email" value= "<?php if(isset($email)){ echo $email; }?>">
