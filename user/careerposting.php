...
$companyname = $_POST['companyname'];// Replace with the actual value
$companyemailaddress = $_POST['companyemailaddress']; // Replace with the actual value
$companyaddress = $_POST['companyaddress'];// Replace with the actual value
$contactno = $_POST['contactno']; // Replace with the actual value
$contactperson = $_POST['contactperson']; // Replace with the actual value
$opportunitytype = isset($_POST['opportunitytype']) ? $_POST['opportunitytype'] : '';
$companyfieldindustry = isset($_POST['companyfieldindustry']) ? implode(', ', $_POST['companyfieldindustry']) : '';
...
if (empty($companyemailaddress)) {
    $companyemailaddress_error = "Please enter Company Email Address";
    $error = 1;
} elseif (!filter_var($companyemailaddress, FILTER_VALIDATE_EMAIL)) {
    $companyemailaddress_error = "Invalid email format";
    $error = 1;
} else {
    // Check if the email address ends with either @gmail.com or @yahoo.com
    $allowed_domains = ["gmail.com", "yahoo.com"];
    $email_parts = explode('@', $companyemailaddress);
    $domain = end($email_parts);

    if (!in_array($domain, $allowed_domains)) {
        $companyemailaddress_error = "Only @gmail.com and @yahoo.com email addresses are allowed";
        $error = 1;
    }
}
...
{
  $companyaddress_error = "Please enter Company Address";
  $error=1;
}

if (empty($contactno)) {
	$contactno_error = "Please enter Contact Number";
	$error = 1;
} else if (!preg_match("/^[0-9]*$/", $contactno) || strlen($contactno) !== 11) {
	$contactno_error = "Please enter a valid 11-digit Contact Number containing only numbers.";
	$error = 1;
}

if(empty($contactperson))
{
  $contactperson_error = "Please enter name of Contact Person";
  $error=1;
}
else if(!preg_match("/^[a-zA-Z ]*$/", $contactperson))
{
  $contactperson_error = "Only letters are allowed";
  $error=1;
}

if($opportunitytype == '') {
	$opportunitytype_error = "Please select Opportunity Type";
	$error = 1;
}

if (isset($_POST["companyfieldindustry"])) {
	// Process the selected values/condition
	
} else {
	$companyfieldindustry_error = "Please select at least one industry";
}

if(empty($message))
{
  $message_error = "Please enter your Message/Description";
  $error=1;
}
if($error==0)
{
...
$status=1; //pending
$query=mysqli_query($conn, "INSERT INTO careers ( companyname, companyemailaddress, companyaddress, contactno, contactperson, opportunitytype, companyfieldindustry, message, status) VALUES ( '$companyname', '$companyemailaddress', '$companyaddress', '$contactno', '$contactperson', '$opportunitytype', '$companyfieldindustry', '$message', '$status')");
if($query)
{
	echo "<script>alert('Your career information is succesfully sent to admin for approval.');</script>";
}
else
{
 ...
 <?php
	...
	<script>
        ...
        function collectData() {
            // Get all checkboxes with the name "companyfieldindustry"
            var checkboxes = document.querySelectorAll('input[name="companyfieldindustry"]:checked');
            ...
            // Do something with the collected data (e.g., display it or send it to a server)
...
return true;
        ...
        <title>AUAAI | Career Posting</title>
...
.form-v4-content .form-detail label.container{
	width: 0%;
  }
...
?>
    ...
    <div class="page-content">
        <div class="form-v4-content">
            <div class="form-left">
                <h2>ADAMSON CAREERS</h2>
                        <hr />
                <p class="text-1">Your complete guide to a career with your university degree.</p>
                <div class="form-left-last">
                <div style="text-align: center;">
    <a class="text-white px-3 btn btn-primary" style="background-color: #022849!important; border-radius: 0.75rem;" href="resultscareer.php">
        Go to Careers
    </a>
</div>
                </div>
            </div>
              <form class="form-detail" action="careerposting.php" method="post" onsubmit="return validateCompanyFieldIndustry();">
            
                    <h2>CAREER POSTING <span><i>Request Form</span></i></h2>
                      <div class="form-row">
                          <label for="comp_name">Company Name <span style="color: red;">*</span></label>
                          <input type="text" name="companyname" id="companyname" class="input-text">
						  <span class="text-danger" ><?php if(!empty($companyname_error)){ echo $companyname_error; } ?></span>
                      </div><br>
                      <div class="form-row">
                          <label for="comp_email">Company Email Address <span style="color: red;">*</span></label>
                          <input type="text" name="companyemailaddress" id="companyemailaddress" class="input-text">
						  <span class="text-danger" ><?php if(!empty($companyemailaddress_error)){ echo $companyemailaddress_error; } ?></span>
                             
                      </div><br>
                      <div class="form-row">
                          <label for="comp_address">Company Address <span style="color: red;">*</span></label>
                          <input type="text" name="companyaddress" id="companyaddress" class="input-text">
                      ...
                      <div class="form-row">
                          ...
                          <input type="text" name="contactno" id="contactno" class="input-text">
						  <span class="text-danger" ><?php if(!empty($contactno_error)){ echo $contactno_error; } ?></span>
                       
                      </div><br>
                      <div class="form-row">
                          <label for="contact_person">Contact Person <span style="color: red;">*</span></label>
                          <input type="text" name="contactperson" id="contactperson" class="input-text">
						  <span class="text-danger" ><?php if(!empty($contactperson_error)){ echo $contactperson_error; } ?></span>
                       
						</div><br>
                      <div class="form-row">
                          <label for="opportunitytype">Select Opportunity Type <span style="color: red;">*</span></label>
                          <select id="opportunitytype" name="opportunitytype">
						  <option value="0" disabled selected>--- Select ---</option>
                              <option value="Any Opportunity Type">Any Opportunity Type</option>
							...
							<span class="text-danger" style="padding-left: 10px;"><?php if(!empty($opportunitytype_error)){ echo $opportunitytype_error; } ?></span>
                      </div><br>
                      <br>

                      <label for="comp_field">Select Company Field Industry <span style="color: red;">*</span></label>
                      <div class="column left">
                          <label class="container">Business & Management
                            <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Business & Management">
                            <span class="checkmark"></span>
                          </label><br>
                          
                          <label class="container">Creative Arts
                            <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Creative Arts">
                            <span class="checkmark"></span>
                          </label><br>
                          
                          <label class="container">Engineering & Mathematics
                            <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Engineering & Mathematics">
                            <span class="checkmark"></span>
                          </label><br>

                          <label class="container">Food, Hospitality & Personal Services
                            <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Food, Hospitality & Personal Services" >
                            <span class="checkmark"></span>
                          </label><br>

                          <label class="container">General Skills & Pathways
                            <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="General Skills & Pathways">
                            <span class="checkmark"></span>
                          </label><br>

                          <label class="container">Humanities, Arts & Social Sciences
                            <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Humanities, Arts & Social Sciences">
                            <span class="checkmark"></span>
                          </label><br>

                          <label class="container">IT & Computer Science
                            <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="IT & Computer Science">
                            <span class="checkmark"></span>
                          </label><br>
						  <span class="text-danger" style="padding-left: 10px;"><?php if(!empty($companyfieldindustry_error)){ echo $companyfieldindustry_error; } ?></span>
                      </div>

                      <div class="column right">

                            <label class="container">Law, Legal Studies & Justice
                              <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Law, Legal Studies & Justice">
                              <span class="checkmark"></span>
                            </label><br>

                            <label class="container">Medical & Health Sciences
                              <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Medical & Health Sciences">
                              <span class="checkmark"></span>
                            </label><br>

                            <label class="container">Property & Built Environment
                              <input type="checkbox"  name="companyfieldindustry[]" id="companyfieldindustry" value="Property & Built Environment">
                              <span class="checkmark"></span>
                            </label><br>

                            <label class="container">Sciences
                              <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Sciences">
                              <span class="checkmark"></span>
                            </label><br>

                            <label class="container">Teaching & Education
                              <input type="checkbox" name="companyfieldindustry[]" id="companyfieldindustry" value="Teaching & Education">
                              <span class="checkmark"></span>
                            </label><br>

                            <label class="container">Trades & Services
                              <input type="checkbox"  name="companyfieldindustry[]" id="companyfieldindustry" value="Trades & Services">
                              <span class="checkmark"></span>
                            </label>
                      ...
                      <br><br><br><br><br><br><br><br><br><br><br><br><br>
                        ...
                        <label for="message">Message or Description <span style="color: red;">*</span></label>
