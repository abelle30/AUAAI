...
<body>
    ...
    <div class="container">
        <div class="row" style="margin-top: 4%">
            ...
            <?php
$pid = intval($_GET['nid']);
$query = mysqli_query($conn, "SELECT newsandannouncements.newstitle,newsandannouncements.author, newsandannouncements.newsdescription, newsandannouncements.author, newsandannouncements.date, newsandannouncements.image, newsfilter.FilterName, newsfilter.id as cid, newsfilter.description 
...
?>
      ...
      <h2 class="card-title"><?php echo htmlentities($row['newstitle']);?></h2>
              <p><b>Category : </b> <a href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><?php echo htmlentities($row['FilterName']);?></a> 
             | <b>Author:</b> <?php echo htmlentities($row['author']);?>
                | <b> Posted on </b><?php echo htmlentities($row['date']);?>
          <hr /> 
