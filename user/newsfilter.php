...
$_SESSION['typid']=intval($_GET['typid']);
  ...
  $query = mysqli_query($conn, "SELECT newsandannouncements.id as pid,newsandannouncements.newstitle,newsandannouncements.author,newsandannouncements.date,newsandannouncements.image,newsandannouncements.newsdescription,newsfilter.FilterName
        ...
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <p><b>Category : <?php echo htmlentities($row['FilterName']); ?></b> 
