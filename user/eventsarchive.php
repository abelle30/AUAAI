...
$query=mysqli_query($conn,"select events.id as pid,events.PostTitle as posttitle,events.PostImage,category.CategoryName as category,category.id as cid,events.SubcategoryId as subcategory,events.PostDetails as postdetails,events.PostingDate as postingdate,events.PostUrl as url from events left join category on category.id=events.CategoryId order by events.id desc  LIMIT $offset, $no_of_records_per_page");
while ($row=mysqli_fetch_array($query)) {
?>
			
				<div class="col-md-4">
                     <div class="card mb-4 border-2">
                         <img class="card-img-top" src="../admin/resources/images/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>"height= "220px">
                        <div class="card-body">
                           <p class="m-0">
                              <!--category-->
