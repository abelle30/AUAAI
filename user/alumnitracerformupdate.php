...
include('emp_record_db/model.php');
...
if (isset($_POST['submit'])) {
    ...
    if(empty($emp_source))
        ...
        {
          $intend_to_stay_error = "Intention to Stay is required.";
          $error=1;
        }
    ...
    else if(!preg_match("/^[a-zA-Z ]*$/", $job_industry_type))
    {
      ...
      $error=1;
        ...
        $monthly_salary_error = "Please enter Monthly Salary";
        $error = 1;
    } 
    elseif(!preg_match("/^[0-9]*$/", $monthly_salary))
    {
        $monthly_salary_error = "Please enter a valid salary containing only numbers.";
        $error = 1;
    }
...
if(strlen($_SESSION['login'])==0)
    {   
header('location: https://auaaiconnect.online/user/alumnitracerform.php');
}
            ...
            ?>
                    ...
                    <div class="">
                        ...
                        <div class="" id="selfEmployedFields" <?php echo ($emp_statusValue === 'selfemployed') ? '' : 'style="display: none;"'; ?>>
                            ...
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Name of the Business</label>
                            ...
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Nature of the Business</label>
                            ...
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Role in the Business</label>
                            ...
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Business Address</label>
                            ...
                            <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="text-align: left;">Business Phone Number</label>
                        ...
                        <td for="source">In your first employment, which of the following has been your source?</td>
                            <div class="employquestion">
                                   <div class="col-md-10" style="text-align: left">
                                    ...
                                    <span class="text-danger" style="padding-left: 10px;"><?php if(!empty($emp_source_error)){ echo $emp_source_error; } ?></span>
                            </div>
                    </div>
                        ...
                        <td for="emp_immediate">Have you been employed immediately 6 months or less after graduation?</td>
                                <div class="employquestion">
                                           <div class="col-md-10" style="text-align: left">
                                            ...
                                            <span class="text-danger" style="padding-left: 10px;"><?php if(!empty($emp_immediate_error)){ echo $emp_immediate_error; } ?></span>
                                </div>
                    </div>
                        ...
                        <td for="job_relate">Is your job related to your course?</td>
                            <div class="employquestion">
                                       <div class="col-md-10" style="text-align: left">
                                        ...
                                        <span class="text-danger" style="padding-left: 10px;"><?php if(!empty($job_relate_error)){ echo $job_relate_error; } ?></span>
                            </div>
                    </div>
                    ...
                    <div class="d-md-flex justify-content-start align-items-left mb-4 py-2">
                        <td>How satisfied are you with your current job?</td>
                            <div class="employquestion">
                                        ...
                                        <span class="text-danger" style="padding-left: 10px;"><?php if(!empty($job_satisfaction_error)){ echo $job_satisfaction_error; } ?></span>
                            </div>
                        ...
                        <td for="intend_to_stay">Do you intend to stay in the same job/profession?</td>
                            <div class="employquestion">
                                       ...
                                       <div class="col-md-10" style="text-align: left">
                                        ...
                                        <span class="text-danger" style="padding-left: 10px;"><?php if(!empty($intend_to_stay_error)){ echo $intend_to_stay_error; } ?></span>
                                    </div>
                            </div>
                    </div>
...
<?php
    ...
    if (isset($_POST['delete_degreerec1'])) {
        ...
        echo "<script>alert('Masters degree record has been removed');window.open('alumnitracerformupdate.php','_self');</script>";
    }
?>
...
<?php
    ...
    if (isset($_POST['delete_degreerec2'])) {
        ...
        echo "<script>alert('Doctorate degree record has been removed');window.open('alumnitracerformupdate.php','_self');</script>";
    }
?>
...
<?php
    ...
    if (isset($_POST['delete_degreerec3'])) {
        ...
        echo "<script>alert('Licensure Exam record has been removed');window.open('alumnitracerformupdate.php','_self');</script>";
    }
?>
