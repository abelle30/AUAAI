...
<!--Bootstrap CSS-->
<link rel="stylesheet" href="resources/vendors/bootstrap-4.6.0/css/bootstrap.min.css"/>
<link rel="stylesheet" href="_text-emphasis.scss">
<!--Font Awesome CSS-->
<link rel="stylesheet" href="resources/vendors/font-awesome/css/all.min.css"/>
...
?>
            ...
            <!--FOR LARGE SREEN-->
            <!--SLIDING SECTION--> 
            <section class="home-slides d-lg-block d-md-block d-none">
                <div class="swiper-container mySwiper">
                    <div class="dark-mask mask-primary"></div>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide p-5">
                            <div class="row p-5 justify-content-center">
                                <div class="col-lg-5 col-md-8 col-sm-12 text-right">
                                    <h1 class="text-white text-cinzel">
                                        ENGAGE YOURSELF
                                        <br/>
                                        WITH ALUMNI ASSOCIATION
                                    </h1>
                                    <p class="text-white">Engaging with your alumni association is an opportunity to stay connected with your alma mater, fellow graduates, and the broader academic community. It offers a platform for networking, professional growth, and giving back through mentorship and support for current students.</p>
                           
                                </div>
                                <div class="col-lg-5 col-md-4 col-sm-12">
                                    <img src="resources/images/auaaii-mainlogo.png" alt="" class="img-fluid"/>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="row p-5 justify-content-center">
                                <div class="col-lg-5 col-md-4 text-center">
                                    <img src="resources/images/auaaii-mainlogo.png" alt="" class="px-lg-5 img-fluid"/>
                                </div>
                                <div class="col-lg-5 col-md-8 text-left">
                                    <h1 class="text-white text-cinzel mt-5">
                                        ADAMSON UNIVERSITY ALUMNI ASSOCIATION INC.
                                    </h1>
                                    <p class="text-white">The Adamson University Alumni Association Inc. is a dynamic and dedicated organization comprising graduates of Adamson University, committed to fostering a sense of unity and camaraderie among its alumni, while actively contributing to the advancement of the institution through various philanthropic and collaborative endeavors.</p>
                                    
                                        
                                        <!--
                                        <li>
                                            <i class="far fa-check-circle text-warning"></i>&nbsp;Schedule your visit
                                        </li>
                                        -->
                                    </ul>
            ...
            <!--Mobile View of Non-slide-->
            <section class="home-slides d-sm-block d-lg-none d-md-none">
                <div class="swiper-container mySwiper text-center py-5 px-3">
                    <div class="dark-mask mask-primary"></div>
                     
                    <h1 class="text-white text-cinzel">ENGAGE YOURSELF
                                        <br/>
                                        WITH ALUMNI ASSOCIATION</h2>
                    <p class="text-white">The Adamson University Alumni Association Inc. is a dynamic and dedicated organization comprising graduates of Adamson University, committed to fostering a sense of unity and camaraderie among its alumni, while actively contributing to the advancement of the institution through various philanthropic and collaborative endeavors.</p>
                    
                </div>
            </section>
             
            <!--EMPLOYMENT RATE & GRADUATE RATE SECTION-->
            <?php
include 'resources/includes/model.php';
$model = new Model();
$rowsEmpStatus = $model->displayEmpStatus();
$rowsCollegesStudentCount = $model->displayCollegesStudentCount();
$rowsCourseRelated = $model->courseRelated();
?>

<section class="bg-light fluid-container align-items-center justify-content-center">
    <div class="p-5 align-items-center justify-content-center">
        <div class="row px-5 mb-4 align-items-center justify-content-center">
            <div class="col-lg-3 col-md-6 align-items-center justify-content-center">
                <div class="home-blog-post h-100 align-items-center justify-content-center">
               
                <a class="text-dark text-center">Employment Status of Alumni</a>
           
                    <div class="image">
                       <canvas id="empRateVS" width="900" height="900"></canvas> <!-- Adjust the width and height as needed -->
                    </div>
                </div>
            </div>
            ...
            <script>
                var empStatusData = {
                    ...
                    datasets: [{
                        ...
                        data: [
                            <?php
                            if (!empty($rowsEmpStatus)) {
                                echo $rowsEmpStatus[0]['employed'] . ', ' . $rowsEmpStatus[0]['unemployed'] . ', ' . $rowsEmpStatus[0]['selfemployed'];
                            } else {
                                echo '0, 0, 0';
                            }
                            ?>
                ...
                var empStatusCtx = document.getElementById('empRateVS').getContext('2d');
                var empStatusChart = new Chart(empStatusCtx, {
                    type: 'bar',
                    data: empStatusData,
            ...
            <script>
                var genderData = {
                    ...
                    datasets: [{
                            ...
                            data: [
                                <?php
                                if (!empty($rowsCollegesStudentCount)) {
                                    echo $rowsCollegesStudentCount[0]['sc_female'] . ', ' . $rowsCollegesStudentCount[0]['sc_female'] . ', ' . $rowsCollegesStudentCount[0]['sc_female'];
                                } else {
                                    echo '0, 0, 0';
                                }
                                ?>
                ...
                var genderCtx = document.getElementById('genderPerCourseChart').getContext('2d');
            ...
            <?php
            if (!empty($rowsCourseRelated)) {
                $jyes = $rowsCourseRelated[0]['jyes'];
                $jno = $rowsCourseRelated[0]['jno'];
                $j_total = $rowsCourseRelated[0]['a_total'];
            }
            ?>
    ...
    <a class="text-dark">Courses and Alumni</a>
</div>
<style>
    .centered-text {
    text-align: center;
                    ...
                    <div class="image">
                        <canvas id="graduationPerCourseChart" width="800" height="400"></canvas><!-- Adjust the width and height as needed -->
                    </div>
                </div>
            </div>
        ...
        ?>
                 ...
                 <br>     
                   <br>   
                        ...
                        <div class="col-lg-12 colmd-6 text-center">
                            <hr/>
                            <a href="newsandannouncement.php" class="btn btn-blue btn-lg mt-3">View All News and Announcements&nbsp;
