...
if (isset($_POST['submit'])) {
    ...
    $Donation_Type_Details = '';

    if ($donationtype === "cash") {
        $cashAmount = htmlspecialchars($_POST['cashAmount']);
        $Donation_Type_Details = $cashAmount;
    } elseif ($donationtype === "goods") {
        $goodsType = htmlspecialchars($_POST['goodsType']);
        $Donation_Type_Details = $goodsType;
    }

    // Create a prepared statement to insert data safely
    $query = "INSERT INTO donations (fname, lname, donationtype, Donation_Type_Details,quantity, usertype) VALUES (?, ?, ?, ?, ?, ?)";
    
    // Prepare the statement
    $stmt = $conn->prepare($query);

    // Bind parameters
    $stmt->bind_param("ssssss", $fname, $lname, $donationtype, $Donation_Type_Details,$quantity, $usertype);

    // Execute the statement
    if ($stmt->execute()) {
      	echo "<script>alert('Donation is succesfully sent');</script>";
    } else {
        // Handle the error
...
?>
    ...
    <div id="all">
         ...
         <div id="heading-breadcrumbs" style="background-color: rgb(200, 211, 230)">
            <div class="container" >
                <div class="row d-flex align-items-center flex-wrap">
                    <div class="col-md-7">
                        <h1  style="font-weight:bold;">DONATE</h1>
                    </div>
        ...
        <div class="donaterow py-5">
            <div class="heading text-center mt-3">
                <p class="lead-donate text-center mb-3">Our association is dedicated to supporting the growth and development 
                    of our alumni community, and your contribution can help make a 
                    real difference in the lives of our graduates.</p>
            </div>
            <div class="heading text-center mt-3">
                <p class="lead-donate text-center mb-3">No matter the amount, your donation will be greatly appreciated and 
                    will help us continue to strengthen our alumni community. 
                    Thank you for considering a donation to our association!</p>
            </div>
            <div class="heading text-center mt-3">
                <h1 class="share"></h1>
            </div>
        </div>
        <div class="donaterow py-4">
            <div class="share">
                <h1 class="share">SHARE EXTRA KINDNESS</h1>
            </div>
        </div>
    
        
        
        <section class="donate py-5" style="background-color: rgb(178, 202, 241)">
        
                <div class="heading text-center mt-3">
                    <p class="how" style="font-size: 30px; color: #007BFF; font-weight: bold; text-align: center; margin-top: 10px;">How do you want to donate?</p>
                </div>
        
            <div class="donatehow">
                <div class="heading text-center mt-3">
                    <div class="if1 heading mt-5 row justify-content-between">
                        <div class="how col-4">
                            <div class="if1" style="font-size: 16px; color: #333; font-weight: bold; text-align: center; padding: 10px; background-color: #f0f0f0;">
                                    If you prefer to donate goods, we kindly ask that 
                                    you donate it directly to our office.
                            </div>
                        ...
                        <div class="how col-4">
                            <div class="if2" style="font-size: 16px; color: #333; font-weight: bold; text-align: center; padding: 10px; background-color: #f0f0f0;">
                                If you choose to donate cash, kindly direct it
                            ...
                            <div class="if2">
                                <table class="table table-success table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">DONATE TO AUAAI</th>
                                        </tr>
                                    </thead>
                                        <tbody>
                                        <tr>
                                            <td>BDO Account No.: 003940564472 <br>
                                            ADAMSON UNIVERSITY
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>BPI Account No.: 002651001733 <br>
                                                ADAMSON OZANAM EDUCATIONAL INST. INC.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>PNB Account No.: 168510005198 <br>
                                                ADAMSON OZANAM EDUCATIONAL INST. INC.
                                            </td>
                                        </tr>
                                        </tbody>
        ...
        <hr style="border-top: 3px solid #555; width:70rem; margin-top:5rem">
        
        <section class="donate py-5" style="background-color: #fff">
        
        
            <div class="donatehow1">
                <div class="heading text-center mt-3">
                    <div class="if1 heading mt-5 row justify-content-between">
                        <div class="how col-4">
                            <h1 class="share">DONATION SURVEY</h1>
                            <div class="where">
                                As an integral part of the university, your feedback is extremely valuable to us.
                            </div>
                        </div>
                        <div class="how col-6">
                            <div class="container mt-2">
                                <form action="donation.php" method="post" action="submit">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input type="radio" class="form-check-input" id="donationtypeCash" name="donationtype" value="cash" required>
                                                <label class="form-check-label" for="donationtypeCash">Cash</label>
                                            </div>
                                            
                                            
                                            <div class="form-group" id="cashInputContainer" style="display: none;">
                                                <label for="cashAmount">Cash Amount (in Peso)</label>
                                    ...
                                    document.addEventListener("DOMContentLoaded", function() {
                                        const cashRadio = document.getElementById("donationtypeCash");
                                        const goodsRadio = document.getElementById("donationtypeGoods");
                                        const cashInputContainer = document.getElementById("cashInputContainer");
                                        const goodsDropdownContainer = document.getElementById("goodsDropdownContainer");
                                        ...
                                        cashRadio.addEventListener("change", function() {
                                            if (cashRadio.checked) {
                                                ...
                                                goodsDropdownContainer.style.display = "none"; // Hide goods dropdown when Cash is selected
                                                cashAmountInput.value = ""; // Clear the input when switching to other options.
                                                cashAmountError.innerText = ""; // Clear any previous error messages.
                                            } else {
                                        ...
                                        goodsRadio.addEventListener("change", function() {
                                            if (goodsRadio.checked) {
                                                goodsDropdownContainer.style.display = "block";
                                                cashInputContainer.style.display = "none"; // Hide cash input and text when Goods is selected
                                                cashAmountInput.value = ""; // Clear the cash input when switching to Goods.
                                                cashAmountError.innerText = ""; // Clear any previous error messages.
                                            } else {
                                                goodsDropdownContainer.style.display = "none";
                                            }
                                        });
                                    
                                        cashAmountInput.addEventListener("input", function() {
                                            const cashAmount = cashAmountInput.value;
                                            if (/[^0-9]/.test(cashAmount)) {
                                                cashAmountError.innerText = "Letters are not allowed.";
                                            } else {
                                            ...
                                            <div class="form-check">
                                                <input type="radio" class="form-check-input" id="donationtypeGoods" name="donationtype" value="goods" required>
                                                <label class="form-check-label" for="donationtypeGoods">Goods</label>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group" id="goodsDropdownContainer" style="display: none;">
                                        ...
                                        <select class="form-control" id="goodsType" name="goodsType">
                                           <option disabled selected>--- Select ---</option>
                                            ...
                                            <option value="Cleaning and Sanitizing Items">Cleaning and Sanitizing Items</option>
                                            <option value="Books and Textbooks">Books and Textbooks</option>
                                            <option value="Toys and Games">Toys and Games</option>
                                            <option value="Others">Others</option>
                                        </select>
                                   
                                   
                               <!-- Add the quantity input field here -->
    ...
    <input type="text" class="form-control" id="quantity" name="quantity">
                                    ...
                                    <center>
                                        ...
                                        <input type="submit" name="submit" value="Submit" class="btn btn-dark btn-block col-md-4">
                                    </center>
                                </form>
                            </div>
                        </div>
